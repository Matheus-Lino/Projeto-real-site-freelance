...
// node_modules/ra-core/node_modules/eventemitter3/index.js
var require_eventemitter3 = __commonJS({
  "node_modules/ra-core/node_modules/eventemitter3/index.js"(exports, module) {
    "use strict";
...
var localStorageStore = function(version, appKey) {
  ...
  var onLocalStorageChange = function(event) {
    var _a12;
    if (((_a12 = event.key) === null || _a12 === void 0 ? void 0 : _a12.substring(0, prefixLength)) !== prefix) {
      return;
    }
...
var StoreContextProvider = function(_a12) {
  var Store = _a12.value, children = _a12.children;
...
var StoreSetter = function(_a12) {
  var value = _a12.value, name = _a12.name, children = _a12.children;
...
// node_modules/ra-core/dist/esm/notification/CloseNotificationContext.js
...
var NotificationContextProvider = function(_a12) {
  var children = _a12.children;
  var _b = (0, import_react11.useState)([]), notifications = _b[0], setNotifications = _b[1];
  var addNotification = (0, import_react11.useCallback)(function(notification) {
    setNotifications(function(notifications2) {
      return __spreadArray(__spreadArray([], notifications2, true), [notification], false);
    });
  }, []);
  var takeNotification = (0, import_react11.useCallback)(function() {
  ...
  var resetNotifications = (0, import_react11.useCallback)(function() {
    setNotifications([]);
  }, []);
...
var useAddNotificationContext = function() {
  return (0, import_react12.useContext)(AddNotificationContext);
};

// node_modules/ra-core/dist/esm/notification/useCloseNotification.js
var import_react13 = __toESM(require_react());
var useCloseNotification = function() {
  var closeNotification = (0, import_react13.useContext)(CloseNotificationContext);
...
var useNotificationContext = function() {
  return (0, import_react14.useContext)(NotificationContext);
};
...
var useNotify = function() {
  ...
  return (0, import_react15.useCallback)(function(message2, options) {
    if (options === void 0) {
      options = {};
    }
    var _a12 = options.type, messageType = _a12 === void 0 ? "info" : _a12, notificationOptions = __rest(options, ["type"]);
    addNotification({
      message: message2,
      type: messageType,
      notificationOptions
...
var TestTranslationProvider = function(_a12) {
  var translate = _a12.translate, messages = _a12.messages, children = _a12.children;
  return React4.createElement(I18nContextProvider, { value: testI18nProvider({ translate, messages }) }, children);
};
var testI18nProvider = function(_a12) {
  var _b = _a12 === void 0 ? {} : _a12, translate = _b.translate, messages = _b.messages;
  return {
    translate: messages ? function(key, options) {
      var message2 = (0, import_get2.default)(messages, key);
      return message2 ? typeof message2 === "function" ? message2(options) : message2 : options === null || options === void 0 ? void 0 : options._;
...
// node_modules/ra-core/dist/esm/i18n/Translate.js
...
var useTranslate = function() {
  ...
  var translate = (0, import_react17.useCallback)(
...
var Translate = function(_a12) {
  var i18nKey = _a12.i18nKey, options = _a12.options, children = _a12.children;
...
var TranslatableContextProvider = function(_a12) {
...
var resolveBrowserLocale = function(defaultLocale, options) {
  var _a12 = window.navigator, language = _a12.language, browserLanguage = _a12.browserLanguage, userLanguage = _a12.userLanguage;
...
var useLocaleState = function() {
  var i18nProvider = useI18nProvider();
  var defaultLocale = (0, import_react20.useMemo)(function() {
...
var useLocales = function(options) {
  var _a12;
  var i18nProvider = useI18nProvider();
  var locales = (0, import_react21.useMemo)(function() {
  ...
  return (_a12 = options === null || options === void 0 ? void 0 : options.locales) !== null && _a12 !== void 0 ? _a12 : locales;
};

// node_modules/ra-core/dist/esm/i18n/useResourceTranslation.js
...
var useResourceTranslation = function(params) {
  ...
  if (userText !== void 0) {
    ...
    return translate(userText, __assign2({ _: userText }, options));
  }
  if (!resourceI18nKey) {
    return translate(baseI18nKey, options);
  }
  return translate(resourceI18nKey, __assign2(__assign2({}, options), { _: translate(baseI18nKey, options) }));
};

// node_modules/ra-core/dist/esm/i18n/useSetLocale.js
var useSetLocale = function() {
  var _a12 = useLocaleState(), setLocale = _a12[1];
  return setLocale;
};
...
var useTranslatable = function(options) {
  ...
  var _a12 = options.defaultLocale, defaultLocale = _a12 === void 0 ? localeFromUI : _a12, locales = options.locales;
  var _b = (0, import_react22.useState)(defaultLocale), selectedLocale = _b[0], setSelectedLocale = _b[1];
  var context = (0, import_react22.useMemo)(function() {
    return {
      locales,
...
var getRecordPaths = function(record, path) {
  ...
  return Object.entries(record).reduce(function(acc, _a12) {
...
var useTranslatableContext = function() {
  var context = (0, import_react23.useContext)(TranslatableContext);
  if (!context) {
...
// node_modules/ra-core/dist/esm/routing/BasenameContextProvider.js
var BasenameContextProvider = function(_a12) {
  var children = _a12.children, basename = _a12.basename;
  return React17.createElement(BasenameContext.Provider, { value: basename }, children);
};

// node_modules/ra-core/dist/esm/routing/AdminRouter.js
var AdminRouter = function(_a12) {
  var _b = _a12.basename, basename = _b === void 0 ? "" : _b, children = _a12.children;
...
var InternalRouter = function(_a12) {
  var children = _a12.children, basename = _a12.basename;
...
var useRemoveFromStore = function(hookTimeKey) {
  ...
  return (0, import_react25.useCallback)(function(key) {
...
var useRemoveItemsFromStore = function(hookTimeKeyPrefix) {
  ...
  return (0, import_react26.useCallback)(function(keyPrefix) {
...
var useRestoreScrollPosition = function(storeKey, debounceMs) {
  ...
  var _a12 = useTrackScrollPosition(storeKey, debounceMs), position = _a12[0], setPosition = _a12[1];
  var location = useLocation();
  (0, import_react27.useEffect)(function() {
    var _a13;
    if (position != null && ((_a13 = location.state) === null || _a13 === void 0 ? void 0 : _a13._scrollToTop) !== true) {
      setPosition(void 0);
...
var useTrackScrollPosition = function(storeKey, debounceMs) {
  ...
  var _a12 = useStore(storeKey), position = _a12[0], setPosition = _a12[1];
  (0, import_react27.useEffect)(function() {
...
var RestoreScrollPosition = function(_a12) {
  var children = _a12.children, storeKey = _a12.storeKey, _b = _a12.debounce, debounce5 = _b === void 0 ? 250 : _b;
...
var useBasename = function() {
  return (0, import_react28.useContext)(BasenameContext);
};
...
var useCreatePath = function() {
  ...
  return (0, import_react29.useCallback)(function(_a12) {
    var resource = _a12.resource, id = _a12.id, type = _a12.type;
...
var ResourceContext = (0, import_react30.createContext)(void 0);

// node_modules/ra-core/dist/esm/core/useResourceContext.js
var useResourceContext = function(props) {
  var context = (0, import_react31.useContext)(ResourceContext);
...
var RecordContext = (0, import_react32.createContext)(void 0);
RecordContext.displayName = "RecordContext";
var RecordContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React19.createElement(RecordContext.Provider, { value }, children);
};

// node_modules/ra-core/dist/esm/controller/record/useRecordContext.js
var useRecordContext = function(props) {
  var context = (0, import_react33.useContext)(RecordContext);
...
var useLogout = function() {
  ...
  var navigateRef = (0, import_react34.useRef)(navigate);
  var location = useLocation();
  var locationRef = (0, import_react34.useRef)(location);
  var basename = useBasename();
  ...
  var logout = (0, import_react34.useCallback)(function(params, redirectFromCaller, redirectToCurrentLocationAfterLogin) {
    if (params === void 0) {
      params = {};
    }
...
var useAuthState = function(params, logoutOnFailure, queryOptions2) {
  ...
  var queryResult = useQuery(__assign3({ queryKey: ["auth", "checkAuth", params], queryFn: function(_a12) {
    return __awaiter(void 0, [_a12], void 0, function(_b) {
      var error_1;
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          ...
          case 1:
            _c.trys.push([1, 3, , 4]);
            return [4, authProvider.checkAuth(__assign3(__assign3({}, params), { signal }))];
          case 2:
            _c.sent();
            return [2, true];
          case 3:
  ...
  var onSuccessEvent = useEvent(onSuccess !== null && onSuccess !== void 0 ? onSuccess : noop2);
  var onSettledEvent = useEvent(onSettled !== null && onSettled !== void 0 ? onSettled : noop2);
  ...
  var result = (0, import_react35.useMemo)(function() {
    return __assign3(__assign3({}, queryResult), { authenticated: queryResult.error ? false : queryResult.data });
  }, [queryResult]);
...
var useLogoutIfAccessDenied = function() {
  ...
  var notify = useNotify();
  var navigate = useNavigate();
  var handleRedirect = (0, import_react36.useCallback)(function(url) {
  ...
  var logoutIfAccessDenied = (0, import_react36.useCallback)(function(errorFromCheckAuth) {
    return __awaiter2(void 0, void 0, void 0, function() {
      var errorFromCheckError_1, logoutUser, redirectTo, shouldNotify, _a12;
      var _b;
      return __generator2(this, function(_c) {
        switch (_c.label) {
          case 0:
            if (!authProvider) {
              return [2, logoutIfAccessDeniedWithoutProvider()];
            }
            _c.label = 1;
          case 1:
            _c.trys.push([1, 3, , 8]);
            return [4, authProvider.checkError(errorFromCheckAuth)];
          case 2:
            _c.sent();
            return [2, false];
          case 3:
            ...
            redirectTo = errorFromCheckError_1 && errorFromCheckError_1.redirectTo != null ? errorFromCheckError_1.redirectTo : errorFromCheckAuth && errorFromCheckAuth.redirectTo ? errorFromCheckAuth.redirectTo : void 0;
            shouldNotify = !(errorFromCheckError_1 && errorFromCheckError_1.message === false || errorFromCheckAuth && errorFromCheckAuth.message === false || (redirectTo === null || redirectTo === void 0 ? void 0 : redirectTo.startsWith("http")));
            if (!shouldNotify) return [3, 7];
            _c.label = 4;
          case 4:
            _c.trys.push([4, 6, , 7]);
            return [4, authProvider.checkAuth({})];
          case 5:
            _c.sent();
            if (logoutUser) {
              notify(getErrorMessage2(errorFromCheckError_1, "ra.notification.logged_out"), { type: "error" });
            } else {
              notify(getErrorMessage2(errorFromCheckError_1, "ra.notification.not_authorized"), { type: "error" });
            }
            return [3, 7];
          case 6:
            _a12 = _c.sent();
...
var logoutIfAccessDeniedWithoutProvider = function() {
  return __awaiter2(void 0, void 0, void 0, function() {
    return __generator2(this, function(_a12) {
      return [2, false];
    });
  });
};
...
var usePermissions = function(params, queryParams) {
  ...
  var _a12 = queryParams !== null && queryParams !== void 0 ? queryParams : {}, onSuccess = _a12.onSuccess, onError = _a12.onError, onSettled = _a12.onSettled, queryOptions2 = __rest3(_a12, ["onSuccess", "onError", "onSettled"]);
  var queryResult = useQuery(__assign4({ queryKey: ["auth", "getPermissions", params], queryFn: function(_a13) {
    return __awaiter3(void 0, [_a13], void 0, function(_b) {
      var permissions;
      var signal = _b.signal;
      return __generator3(this, function(_c) {
        switch (_c.label) {
          case 0:
            ...
            return [4, authProvider.getPermissions(__assign4(__assign4({}, params), { signal }))];
          case 1:
            permissions = _c.sent();
  ...
  var result = (0, import_react37.useMemo)(function() {
    return __assign4(__assign4({}, queryResult), { permissions: queryResult.data });
  }, [queryResult]);
...
var useAuthenticated = function(_a12) {
  if (_a12 === void 0) {
    _a12 = {};
  }
  var params = _a12.params, _b = _a12.logoutOnFailure, logoutOnFailure = _b === void 0 ? true : _b, options = __rest4(_a12, ["params", "logoutOnFailure"]);
...
var WithPermissions = function(props) {
  var authParams = props.authParams, children = props.children, render = props.render, component = props.component, _a12 = props.loading, Loading = _a12 === void 0 ? null : _a12, staticContext = props.staticContext, rest = __rest5(props, ["authParams", "children", "render", "component", "loading", "staticContext"]);
  ...
  if (isAuthenticationPending || isPendingPermissions) {
    return Loading ? React20.createElement(Loading, null) : null;
  }
  if (component) {
    return (0, import_react38.createElement)(component, __assign5({ permissions }, rest));
  }
  if (render) {
...
var Authenticated = function(props) {
  var authParams = props.authParams, _a12 = props.loading, loading = _a12 === void 0 ? null : _a12, children = props.children;
  var _b = useAuthenticated({ params: authParams }), isPending = _b.isPending, isError = _b.isError;
  if (isPending || isError) {
    return loading;
  }
  return React21.createElement(React21.Fragment, null, children);
};
...
var useFilterState_default = (function(_a12) {
  var _b = _a12.filterToQuery, filterToQuery = _b === void 0 ? defaultFilterToQuery : _b, _c = _a12.permanentFilter, permanentFilter = _c === void 0 ? {} : _c, _d = _a12.debounceTime, debounceTime = _d === void 0 ? 500 : _d;
  var permanentFilterProp = (0, import_react41.useRef)(permanentFilter);
  var latestValue = (0, import_react41.useRef)();
  var _e = (0, import_react41.useState)(__assign6(__assign6({}, permanentFilter), filterToQuery(""))), filter = _e[0], setFilterValue = _e[1];
  ...
  (0, import_react41.useEffect)(function() {
    if (!(0, import_isEqual.default)(permanentFilterProp.current, permanentFilter)) {
      ...
      setFilterValue(__assign6(__assign6({}, permanentFilter), filterToQuery(latestValue.current || "")));
    }
  }, [permanentFilterSignature, permanentFilterProp, filterToQuery]);
  var setFilter = (0, import_react41.useCallback)((0, import_debounce2.default)(function(value) {
    setFilterValue(__assign6(__assign6({}, permanentFilter), filterToQuery(value)));
...
var removeEmpty = function(object) {
  return Object.keys(object).reduce(function(acc, key) {
    ...
    return isEmpty(child) ? acc : __assign7(__assign7({}, acc), (_a12 = {}, _a12[key] = child, _a12));
  }, {});
};
...
var removeKey = function(target, path) {
  return Object.keys(target).reduce(function(acc, key) {
    var _a12;
    if (key !== path) {
      return Object.assign({}, acc, (_a12 = {}, _a12[key] = target[key], _a12));
    }
    return acc;
  }, {});
};
var deepRemoveKey = function(target, path) {
  ...
  return Object.assign({}, target, (_a12 = {}, _a12[deepKey] = deep, _a12));
};
  ...
  switch (action.type) {
    case SET_SORT:
      if (action.payload.field === previousState.sort) {
        return __assign8(__assign8({}, previousState), { order: (_b = action.payload.order) !== null && _b !== void 0 ? _b : oppositeOrder(previousState.order), page: 1 });
      }
      return __assign8(__assign8({}, previousState), { sort: action.payload.field, order: action.payload.order || SORT_ASC, page: 1 });
    case SET_PAGE:
      return __assign8(__assign8({}, previousState), { page: action.payload });
    case SET_PER_PAGE:
      return __assign8(__assign8({}, previousState), { page: 1, perPage: action.payload });
    case SET_FILTER: {
      return __assign8(__assign8({}, previousState), { page: 1, filter: action.payload.filter, displayedFilters: action.payload.displayedFilters ? action.payload.displayedFilters : previousState.displayedFilters });
    }
    case SHOW_FILTER: {
      if (previousState.displayedFilters && previousState.displayedFilters[action.payload.filterName]) {
        return previousState;
      }
      return __assign8(__assign8({}, previousState), {
        ...
        displayedFilters: __assign8(__assign8({}, previousState.displayedFilters), (_a12 = {}, _a12[action.payload.filterName] = true, _a12))
      });
    }
    case HIDE_FILTER: {
      return __assign8(__assign8({}, previousState), {
        ...
        displayedFilters: previousState.displayedFilters ? Object.keys(previousState.displayedFilters).reduce(function(filters, filter) {
          var _a13;
          return filter !== action.payload ? __assign8(__assign8({}, filters), (_a13 = {}, _a13[filter] = true, _a13)) : filters;
...
var useSortState = function(initialSort) {
  ...
  var _a12 = (0, import_react42.useReducer)(sortReducer, initialSort), sort = _a12[0], dispatch = _a12[1];
  ...
  return {
    setSort: (0, import_react42.useCallback)(function(sort2) {
      return dispatch({ type: "SET_SORT", payload: sort2 });
    }, [dispatch]),
    setSortField: (0, import_react42.useCallback)(function(field) {
      return dispatch({ type: "SET_SORT_FIELD", payload: field });
    }, [dispatch]),
    setSortOrder: (0, import_react42.useCallback)(function(order) {
...
var paginationReducer = function(prevState, nextState) {
  return __assign9(__assign9({}, prevState), nextState);
};
...
var usePaginationState_default = (function(initialPagination) {
  ...
  var _a12 = (0, import_react43.useReducer)(paginationReducer, __assign9(__assign9({}, defaultPagination), initialPagination)), pagination = _a12[0], setPagination = _a12[1];
  var isFirstRender = (0, import_react43.useRef)(true);
  var setPerPage = (0, import_react43.useCallback)(function(perPage) {
    return setPagination({ perPage, page: 1 });
  }, []);
  var setPage = (0, import_react43.useCallback)(function(page) {
...
// node_modules/ra-core/dist/esm/controller/button/useDeleteController.js
...
var populateQueryCache = function(_a12) {
  var data = _a12.data, queryClient = _a12.queryClient, _b = _a12.staleTime, staleTime = _b === void 0 ? 1e3 : _b;
...
var useDataProvider = function() {
  var dataProvider = (0, import_react45.useContext)(DataProviderContext_default) || defaultDataProvider;
  var queryClient = useQueryClient();
  var logoutIfAccessDenied = useLogoutIfAccessDenied_default();
        ...
        return function() {
          ...
          try {
            return dataProvider[type].apply(dataProvider, args).then(function(response) {
              ...
              if ((_a12 = response === null || response === void 0 ? void 0 : response.meta) === null || _a12 === void 0 ? void 0 : _a12.prefetched) {
                populateQueryCache({
...
// node_modules/ra-core/dist/esm/dataProvider/useMutationWithMutationMode.js
...
var AddUndoableMutationContext = (0, import_react46.createContext)(function() {
});

// node_modules/ra-core/dist/esm/dataProvider/undo/useAddUndoableMutation.js
var useAddUndoableMutation = function() {
  return (0, import_react47.useContext)(AddUndoableMutationContext);
};
...
var useMutationWithMutationMode = function(params, options) {
  ...
  var mutationKey = options.mutationKey, _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, mutationFn = options.mutationFn, getMutateWithMiddlewares = options.getMutateWithMiddlewares, updateCache = options.updateCache, getQueryKeys = options.getQueryKeys, onUndo = options.onUndo, mutationOptions2 = __rest6(options, ["mutationKey", "mutationMode", "mutationFn", "getMutateWithMiddlewares", "updateCache", "getQueryKeys", "onUndo"]);
  if (mutationFn == null) {
  ...
  var onUndoEvent = useEvent(onUndo !== null && onUndo !== void 0 ? onUndo : noop4);
  var getMutateWithMiddlewaresEvent = useEvent(getMutateWithMiddlewares !== null && getMutateWithMiddlewares !== void 0 ? getMutateWithMiddlewares : noop4);
  var mode = (0, import_react48.useRef)(mutationMode);
  (0, import_react48.useEffect)(function() {
    mode.current = mutationMode;
  }, [mutationMode]);
  var paramsRef = (0, import_react48.useRef)(params);
  var snapshot = (0, import_react48.useRef)([]);
  var mutateWithMiddlewares = (0, import_react48.useRef)(mutationFnEvent);
  var callTimeOnError = (0, import_react48.useRef)();
  var callTimeOnSettled = (0, import_react48.useRef)();
  var hasCallTimeOnSuccess = (0, import_react48.useRef)(false);
  var mutation = useMutation(__assign10(__assign10({ mutationKey, mutationFn: function(params2) {
    return __awaiter4(void 0, void 0, void 0, function() {
      return __generator4(this, function(_a13) {
        if (params2 == null) {
          throw new Error("useMutationWithMutationMode mutation requires parameters");
        }
        return [2, mutateWithMiddlewares.current(params2).then(function(_a14) {
          var data = _a14.data;
          return data;
        })];
      });
    });
  } }, mutationOptions2), { onMutate: function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
    return __awaiter4(void 0, void 0, void 0, function() {
      ...
      return __generator4(this, function(_a13) {
        switch (_a13.label) {
          case 0:
            if (!mutationOptions2.onMutate) return [3, 2];
            return [4, mutationOptions2.onMutate.apply(mutationOptions2, args)];
          case 1:
            userContext = _a13.sent() || {};
            return [2, __assign10({ snapshot: snapshot.current }, userContext)];
          case 2:
    ...
    if (mode.current === "optimistic" || mode.current === "undoable") {
      ...
      onMutateResult.snapshot.forEach(function(_a13) {
    ...
    if (mutationOptions2.onError) {
      return mutationOptions2.onError.apply(mutationOptions2, args);
    }
  }, onSuccess: function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    if (mode.current === "pessimistic") {
      ...
      updateCacheEvent(__assign10(__assign10({}, paramsRef.current), variables), {
        mutationMode: mode.current
      }, data);
      if (mutationOptions2.onSuccess && !hasCallTimeOnSuccess.current) {
        mutationOptions2.onSuccess.apply(mutationOptions2, args);
      }
    }
  }, onSettled: function() {
    var args = [];
    ...
    if (mode.current === "optimistic" || mode.current === "undoable") {
      ...
      getQueryKeysEvent(__assign10(__assign10({}, paramsRef.current), variables), {
        mutationMode: mode.current
    ...
    if (mutationOptions2.onSettled) {
      return mutationOptions2.onSettled.apply(mutationOptions2, args);
    }
  } }));
  var mutate = function() {
    var args_1 = [];
    ...
    return __awaiter4(void 0, __spreadArray5([], args_1, true), void 0, function(callTimeParams, callTimeOptions) {
      var mutationMode2, _a13, returnPromise, onError, onSettled, onSuccess, otherCallTimeOptions, optimisticResult;
      ...
      return __generator4(this, function(_b) {
        switch (_b.label) {
          case 0:
            mutationMode2 = callTimeOptions.mutationMode, _a13 = callTimeOptions.returnPromise, returnPromise = _a13 === void 0 ? mutationOptions2.returnPromise : _a13, onError = callTimeOptions.onError, onSettled = callTimeOptions.onSettled, onSuccess = callTimeOptions.onSuccess, otherCallTimeOptions = __rest6(callTimeOptions, ["mutationMode", "returnPromise", "onError", "onSettled", "onSuccess"]);
            paramsRef.current = params;
            if (getMutateWithMiddlewares) {
              mutateWithMiddlewares.current = getMutateWithMiddlewaresEvent(function(params2) {
            ...
            snapshot.current = getSnapshotEvent(getQueryKeysEvent(__assign10(__assign10({}, paramsRef.current), callTimeParams), {
              mutationMode: mode.current
            }));
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign10(__assign10({}, paramsRef.current), callTimeParams), __assign10({ onSuccess }, otherCallTimeOptions))];
              }
              return [2, mutation.mutate(__assign10(__assign10({}, paramsRef.current), callTimeParams), __assign10({ onSuccess }, otherCallTimeOptions))];
            }
            return [4, Promise.all(snapshot.current.map(function(_a14) {
              var queryKey = _a14[0];
              return queryClient.cancelQueries({ queryKey });
            }))];
          case 1:
            _b.sent();
            optimisticResult = updateCacheEvent(__assign10(__assign10({}, paramsRef.current), callTimeParams), {
              mutationMode: mode.current
            }, void 0);
            setTimeout(function() {
              if (onSuccess) {
                onSuccess(optimisticResult, __assign10(__assign10({}, paramsRef.current), callTimeParams), {
                ...
                mutationOptions2.onSuccess(optimisticResult, __assign10(__assign10({}, paramsRef.current), callTimeParams), {
                  snapshot: snapshot.current
                }, {
                  client: queryClient,
                  mutationKey,
            ...
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign10(__assign10({}, paramsRef.current), callTimeParams))];
            } else {
              addUndoableMutation(function(_a14) {
                var isUndo = _a14.isUndo;
                if (isUndo) {
                  if (onUndo) {
                    onUndoEvent(__assign10(__assign10({}, paramsRef.current), callTimeParams), {
                      mutationMode: mode.current
                    });
                  }
                  snapshot.current.forEach(function(_a15) {
                    var key = _a15[0], value = _a15[1];
                    queryClient.setQueryData(key, value);
                  });
                } else {
                  mutation.mutate(__assign10(__assign10({}, paramsRef.current), callTimeParams));
                }
              });
            }
            return [
  ...
  var mutationResult = (0, import_react48.useMemo)(function() {
    return __assign10({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
...
var useDelete = function(resource, params, options) {
  ...
  var queryClient = useQueryClient();
  var _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, mutationOptions2 = __rest7(options, ["mutationMode"]);
  var _b = useMutationWithMutationMode(__assign11({ resource }, params), __assign11(__assign11({}, mutationOptions2), { mutationKey: [resource, "delete", params], mutationMode, mutationFn: function(_a13) {
    var resource2 = _a13.resource, params2 = __rest7(_a13, ["resource"]);
    if (resource2 == null) {
  ...
  }, updateCache: function(_a13, _b2) {
    var resource2 = _a13.resource, params2 = __rest7(_a13, ["resource"]);
    var mutationMode2 = _b2.mutationMode;
    var now = Date.now();
    var updatedAt = mutationMode2 === "undoable" ? now + 5 * 1e3 : now;
    var updateColl = function(old) {
      ...
      return __spreadArray6(__spreadArray6([], old.slice(0, index), true), old.slice(index + 1), true);
    };
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      if (!res || !res.pages)
        return res;
      return __assign11(__assign11({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign11(__assign11({}, page), { data: newCollection, total: page.total ? page.total - 1 : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getManyReference"] }, function(res) {
      ...
      var newCollection = updateColl(res.data);
      var recordWasFound = newCollection.length < res.data.length;
      return recordWasFound ? __assign11(__assign11({}, res), { data: newCollection, total: res.total - 1 }) : res;
    }, { updatedAt });
    return params2.previousData;
  }, getQueryKeys: function(_a13) {
    var resource2 = _a13.resource;
    var queryKeys = [
      [resource2, "getList"],
    ...
    context.snapshot.forEach(function(_a13) {
      var queryKey = _a13[0];
      queryClient.invalidateQueries({ queryKey });
    });
  ...
  var deleteOne = useEvent(function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return mutate(__assign11({ resource: callTimeResource }, callTimeParams), callTimeOptions);
  });
...
var useRecordSelection = function(args) {
  var _a12 = args.resource, resource = _a12 === void 0 ? "" : _a12, _b = args.disableSyncWithStore, disableSyncWithStore = _b === void 0 ? false : _b;
  var storeKey = "".concat(resource, ".selectedIds");
  var _c = (0, import_react49.useState)(defaultSelection), localIds = _c[0], setLocalIds = _c[1];
  ...
  var reset = (0, import_react49.useCallback)(function() {
  ...
  var selectionModifiers = (0, import_react49.useMemo)(function() {
    return {
...
var useUnselect = function(resource) {
  var _a12 = useRecordSelection(resource ? { resource } : { disableSyncWithStore: true }), unselect = _a12[1].unselect;
  return (0, import_react50.useCallback)(function(ids) {
    unselect(ids);
  }, [unselect]);
};
...
var useRedirect = function() {
  ...
  return (0, import_react51.useCallback)(function(redirectTo, resource, id, data, state) {
    var _a12;
    if (resource === void 0) {
      resource = "";
    }
    ...
    if (!redirectTo) {
      ...
      var absoluteTarget = typeof target === "string" ? "".concat(basename).concat(target.startsWith("/") ? "" : "/").concat(target) : __assign12({ pathname: "".concat(basename).concat(((_a12 = target.pathname) === null || _a12 === void 0 ? void 0 : _a12.startsWith("/")) ? "" : "/").concat(target.pathname) }, target);
      navigate(absoluteTarget, {
        state: __assign12({ _scrollToTop: true }, state)
      });
      return;
      ...
      navigate(createPath({ resource, id, type: redirectTo }), {
        state: (
          ...
          redirectTo === "list" ? state : __assign12({ _scrollToTop: true }, state)
        )
      });
      return;
    }
...
var useDeleteController = function(props) {
  var _a12 = props.redirect, redirectTo = _a12 === void 0 ? "list" : _a12, _b = props.mutationMode, mutationMode = _b === void 0 ? "undoable" : _b, _c = props.mutationOptions, mutationOptions2 = _c === void 0 ? {} : _c, successMessage = props.successMessage;
  var mutationMeta = mutationOptions2.meta, otherMutationOptions = __rest8(mutationOptions2, ["meta"]);
  ...
  var _d = useDelete(resource, void 0, {
    ...
    onError: function(error) {
      notify(typeof error === "string" ? error : (error === null || error === void 0 ? void 0 : error.message) || "ra.notification.http_error", {
        type: "error",
        messageArgs: {
          _: typeof error === "string" ? error : error === null || error === void 0 ? void 0 : error.message
        }
      });
    }
  }), deleteOne = _d[0], isPending = _d[1].isPending;
  var handleDelete = (0, import_react52.useCallback)(function() {
    if (!record) {
    ...
    deleteOne(resource, {
      ...
      previousData: record,
      meta: mutationMeta
    }, __assign13({ mutationMode }, otherMutationOptions));
  }, [
    deleteOne,
    mutationMeta,
    mutationMode,
...
var useDeleteWithUndoController = function(props) {
  ...
  var _a12 = useDeleteController(__assign14(__assign14({}, props), { mutationMode: "undoable" })), isPending = _a12.isPending, controllerHandleDelete = _a12.handleDelete;
...
var useDeleteWithConfirmController = function(props) {
  var mutationMode = props.mutationMode, onClick = props.onClick, record = props.record, _a12 = props.redirect, redirectTo = _a12 === void 0 ? "list" : _a12, successMessage = props.successMessage, _b = props.mutationOptions, mutationOptions2 = _b === void 0 ? {} : _b, rest = __rest9(props, ["mutationMode", "onClick", "record", "redirect", "successMessage", "mutationOptions"]);
  var _c = (0, import_react53.useState)(false), open = _c[0], setOpen = _c[1];
  var resource = useResourceContext(props);
  var notify = useNotify();
  var unselect = useUnselect(resource);
  var redirect = useRedirect();
  var translate = useTranslate();
  var _d = useDeleteController(__assign15({ mutationMode, mutationOptions: __assign15({ onSuccess: function() {
    setOpen(false);
    notify(successMessage !== null && successMessage !== void 0 ? successMessage : "resources.".concat(resource, ".notifications.deleted"), {
      type: "info",
      messageArgs: {
  ...
  } }, mutationOptions2), record, redirect: redirectTo, successMessage }, rest)), isPending = _d.isPending, controllerHandleDelete = _d.handleDelete;
...
// node_modules/ra-core/dist/esm/controller/button/useBulkDeleteController.js
...
var useDeleteMany = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, mutationOptions2 = __rest10(options, ["mutationMode"]);
  var _b = useMutationWithMutationMode(__assign16({ resource }, params), __assign16(__assign16({}, mutationOptions2), { mutationKey: [resource, "deleteMany", params], mutationMode, mutationFn: function(_a13) {
    var resource2 = _a13.resource, params2 = __rest10(_a13, ["resource"]);
    if (resource2 == null) {
    ...
    var updateColl = function(old) {
      ...
      if (!old)
        return old;
      var newCollection = __spreadArray8([], old, true);
      (_a14 = params2.ids) === null || _a14 === void 0 ? void 0 : _a14.forEach(function(id) {
        ...
        newCollection = __spreadArray8(__spreadArray8([], newCollection.slice(0, index), true), newCollection.slice(index + 1), true);
      });
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
      ...
      var newCollection = updateColl(res.data);
      var recordWasFound = newCollection.length < res.data.length;
      return recordWasFound ? __assign16(__assign16({}, res), { data: newCollection, total: res.total ? res.total - (res.data.length - newCollection.length) : void 0 }) : res;
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      if (!res || !res.pages)
        return res;
      return __assign16(__assign16({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign16(__assign16({}, page), { data: newCollection, total: page.total ? page.total - (page.data.length - newCollection.length) : void 0 }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getManyReference"] }, function(res) {
      ...
      if (res.total) {
        return __assign16(__assign16({}, res), { data: newCollection, total: res.total - (res.data.length - newCollection.length) });
      }
      if (res.pageInfo) {
        return __assign16(__assign16({}, res), { data: newCollection });
      }
  ...
  var deleteMany = useEvent(function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return mutate(__assign16({ resource: callTimeResource }, callTimeParams), callTimeOptions);
  });
...
var ListContext = (0, import_react55.createContext)(null);
ListContext.displayName = "ListContext";

// node_modules/ra-core/dist/esm/controller/list/useListContext.js
var useListContext = function() {
  var context = (0, import_react56.useContext)(ListContext);
  if (!context) {
...
var useBulkDeleteController = function(props) {
  var _a12 = props.mutationMode, mutationMode = _a12 === void 0 ? "undoable" : _a12, _b = props.mutationOptions, mutationOptions2 = _b === void 0 ? {} : _b, successMessage = props.successMessage;
  var mutationMeta = mutationOptions2.meta, otherMutationOptions = __rest11(mutationOptions2, ["meta"]);
  var resource = useResourceContext(props);
  var notify = useNotify();
  var refresh = useRefresh();
  var translate = useTranslate();
  var _c = useListContext(), selectedIds = _c.selectedIds, onUnselectItems = _c.onUnselectItems;
  var _d = useDeleteMany(resource, void 0, {
    onSuccess: function() {
      notify(successMessage !== null && successMessage !== void 0 ? successMessage : "resources.".concat(resource, ".notifications.deleted"), {
        type: "info",
        messageArgs: {
  ...
  var handleDelete = (0, import_react57.useCallback)(function() {
    deleteMany(resource, {
      ids: selectedIds,
      meta: mutationMeta
    }, __assign17({ mutationMode }, otherMutationOptions));
  }, [
    deleteMany,
    mutationMeta,
    mutationMode,
...
// node_modules/ra-core/dist/esm/controller/button/useUpdateController.js
...
var useUpdate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions2 = __rest12(options, ["mutationMode", "getMutateWithMiddlewares"]);
  var dataProviderUpdate = useEvent(function(resource2, params2) {
    return dataProvider.update(resource2, params2);
  });
  var _b = useMutationWithMutationMode(__assign18({ resource }, params), __assign18(__assign18({}, mutationOptions2), { mutationKey: [resource, "update", params], mutationMode, mutationFn: function(_a13) {
    var resource2 = _a13.resource, params2 = __rest12(_a13, ["resource"]);
    if (resource2 == null) {
  ...
  }, updateCache: function(_a13, _b2, result) {
    var resource2 = _a13.resource, params2 = __rest12(_a13, ["resource"]);
    var mutationMode2 = _b2.mutationMode;
    var now = Date.now();
    var updatedAt = mutationMode2 === "undoable" ? now + 5 * 1e3 : now;
    var clonedData = JSON.parse(JSON.stringify(mutationMode2 === "pessimistic" ? result : params2 === null || params2 === void 0 ? void 0 : params2.data));
    var updateColl = function(old) {
      if (!old)
        return old;
      var index = old.findIndex(
        // eslint-disable-next-line eqeqeq
        function(record) {
          return record.id == (params2 === null || params2 === void 0 ? void 0 : params2.id);
        }
      );
      if (index === -1) {
        return old;
      }
      return __spreadArray9(__spreadArray9(__spreadArray9([], old.slice(0, index), true), [
        __assign18(__assign18({}, old[index]), clonedData)
      ], false), old.slice(index + 1), true);
    };
    var previousRecord = queryClient.getQueryData([
      resource2,
      "getOne",
      { id: String(params2 === null || params2 === void 0 ? void 0 : params2.id), meta: params2 === null || params2 === void 0 ? void 0 : params2.meta }
    ]);
    ...
    var optimisticResult = __assign18(__assign18({}, previousRecord), clonedData);
    ...
    if (getMutateWithMiddlewares) {
      ...
      return function(args) {
        var resource2 = args.resource, params2 = __rest12(args, ["resource"]);
        return mutateWithMiddlewares_1(resource2, params2);
      };
    }
    return function(args) {
  ...
  var update = useEvent(function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return mutate(__assign18({ resource: callTimeResource }, callTimeParams), callTimeOptions);
  });
...
var useUpdateController = function(props) {
  var _a12 = props.redirect, redirectTo = _a12 === void 0 ? false : _a12, _b = props.mutationMode, mutationMode = _b === void 0 ? "undoable" : _b, _c = props.mutationOptions, mutationOptions2 = _c === void 0 ? {} : _c, successMessage = props.successMessage;
  var mutationMeta = mutationOptions2.meta, otherMutationOptions = __rest13(mutationOptions2, ["meta"]);
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  var notify = useNotify();
  var redirect = useRedirect();
  var translate = useTranslate();
  var _d = useUpdate(resource, void 0, __assign19({ onSuccess: function() {
  ...
  }, mutationMode }, otherMutationOptions)), updateOne = _d[0], isPending = _d[1].isPending;
  var handleUpdate = (0, import_react58.useCallback)(function(data) {
    if (!record) {
...
// node_modules/ra-core/dist/esm/controller/button/useBulkUpdateController.js
...
var useUpdateMany = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions2 = __rest14(options, ["mutationMode", "getMutateWithMiddlewares"]);
  var dataProviderUpdateMany = useEvent(function(resource2, params2) {
    return dataProvider.updateMany(resource2, params2);
  });
  var _b = useMutationWithMutationMode(__assign20({ resource }, params), __assign20(__assign20({}, mutationOptions2), { mutationKey: [resource, "updateMany", params], mutationMode, mutationFn: function(_a13) {
    var resource2 = _a13.resource, params2 = __rest14(_a13, ["resource"]);
    if (resource2 == null) {
    ...
    var resource2 = _a13.resource, params2 = __rest14(_a13, ["resource"]);
    var mutationMode2 = _b2.mutationMode;
    var updatedAt = mutationMode2 === "undoable" ? Date.now() + 1e3 * 5 : Date.now();
    var clonedData = (params2 === null || params2 === void 0 ? void 0 : params2.data) ? JSON.parse(JSON.stringify(params2 === null || params2 === void 0 ? void 0 : params2.data)) : void 0;
    var updateColl = function(old) {
      var _a14;
      if (!old)
        return old;
      var newCollection = __spreadArray10([], old, true);
      ((_a14 = params2 === null || params2 === void 0 ? void 0 : params2.ids) !== null && _a14 !== void 0 ? _a14 : []).forEach(function(id) {
        ...
        newCollection = __spreadArray10(__spreadArray10(__spreadArray10([], newCollection.slice(0, index), true), [
          __assign20(__assign20({}, newCollection[index]), clonedData)
        ], false), newCollection.slice(index + 1), true);
      });
      return newCollection;
    };
    ((_c = params2 === null || params2 === void 0 ? void 0 : params2.ids) !== null && _c !== void 0 ? _c : []).forEach(function(id) {
      queryClient.setQueryData([
        resource2,
        "getOne",
        { id: String(id), meta: params2 === null || params2 === void 0 ? void 0 : params2.meta }
      ], function(record) {
        return __assign20(__assign20({}, record), clonedData);
      }, { updatedAt });
    });
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
      return res && res.data ? __assign20(__assign20({}, res), { data: updateColl(res.data) }) : res;
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      return res && res.pages ? __assign20(__assign20({}, res), { pages: res.pages.map(function(page) {
        return __assign20(__assign20({}, page), { data: updateColl(page.data) });
      }) }) : res;
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
    ...
    return params2 === null || params2 === void 0 ? void 0 : params2.ids;
  }, getQueryKeys: function(_a13) {
    var resource2 = _a13.resource;
    var queryKeys = [
      [resource2, "getOne"],
    ...
    if (getMutateWithMiddlewares) {
      ...
      return function(args) {
        var resource2 = args.resource, params2 = __rest14(args, ["resource"]);
        return mutateWithMiddlewares_1(resource2, params2);
      };
    }
    return function(args) {
  ...
  var updateMany = useEvent(function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return mutate(__assign20({ resource: callTimeResource }, callTimeParams), callTimeOptions);
  });
...
var useBulkUpdateController = function(props) {
  var onSuccess = props.onSuccess, onError = props.onError, _a12 = props.mutationMode, mutationMode = _a12 === void 0 ? "undoable" : _a12, _b = props.mutationOptions, mutationOptions2 = _b === void 0 ? {} : _b, successMessage = props.successMessage;
  var mutationMeta = mutationOptions2.meta, otherMutationOptions = __rest15(mutationOptions2, ["meta"]);
  var resource = useResourceContext(props);
  var notify = useNotify();
  var refresh = useRefresh();
  var translate = useTranslate();
  var _c = useListContext(), selectedIds = _c.selectedIds, onUnselectItems = _c.onUnselectItems;
  var _d = useUpdateMany(resource, void 0, __assign21({ onSuccess: onSuccess !== null && onSuccess !== void 0 ? onSuccess : (function() {
    notify(successMessage !== null && successMessage !== void 0 ? successMessage : "resources.".concat(resource, ".notifications.updated"), {
      type: "info",
      messageArgs: {
        smart_count: selectedIds.length,
  ...
  var handleUpdate = (0, import_react59.useCallback)(function(data) {
    updateMany(resource, {
      data,
      ids: selectedIds,
      meta: mutationMeta
    }, __assign21({ mutationMode }, otherMutationOptions));
  }, [
    updateMany,
    mutationMeta,
    mutationMode,
...
var fetchJson = function(url, options) {
  ...
  return fetch(url, __assign22(__assign22({}, options), { headers: requestHeaders })).then(function(response) {
    ...
    var status = _a12.status, statusText = _a12.statusText, headers = _a12.headers, body = _a12.body;
    var json;
    try {
...
var flattenObject = function(value, path) {
  ...
  if (isValidObject(value)) {
    return Object.assign.apply(Object, __spreadArray11([{}], Object.keys(value).map(function(key) {
      return flattenObject(value[key], path.concat([key]));
    }), false));
  } else {
    return path.length ? (_a12 = {}, _a12[path.join(".")] = value, _a12) : value;
  }
};

// node_modules/ra-core/node_modules/eventemitter3/index.mjs
  ...
  return new Proxy(defaultDataProvider, {
    get: function(target, name) {
      ...
      return function(resource) {
        ...
        return (_a12 = dataProviderMatcher(resource))[name].apply(_a12, __spreadArray12([resource], params, false));
      };
    }
  });
};
...
var testDataProvider = function(overrides) {
  return __assign23(__assign23({}, defaultTestDataProvider), overrides);
};
...
var withLifecycleCallbacks = function(dataProvider, handlers) {
  return __assign24(__assign24({}, dataProvider), { getList: function(resource, params) {
    return __awaiter6(this, void 0, void 0, function() {
      var newParams, result, _a12;
    ...
    return __awaiter6(this, void 0, void 0, function() {
      var newParams, _a12, result, afterSaveHandlers, records;
      return __generator6(this, function(_b) {
        switch (_b.label) {
          case 0:
            newParams = params;
...
var applyCallbacks = function(_a12) {
  return __awaiter6(this, arguments, void 0, function(_b) {
...
var useIsDataLoaded = function(queryKey, options) {
  ...
  var _a12 = options.enabled, enabled = _a12 === void 0 ? true : _a12;
  var queryClient = useQueryClient();
  var _b = (0, import_react60.useState)(function() {
    if (!enabled) {
      return false;
    }
...
var useLoading = function() {
  ...
  var mountedRef = import_react61.default.useRef(false);
  var isFetchingRef = import_react61.default.useRef(client.isFetching() > 0);
  var isMutatingRef = import_react61.default.useRef(client.isMutating() > 0);
  var _a12 = import_react61.default.useState(isFetchingRef.current || isMutatingRef.current), isLoading = _a12[0], setIsLoading = _a12[1];
...
var useGetOne = function(resource, _a12, options) {
  var id = _a12.id, meta = _a12.meta;
  if (options === void 0) {
    options = {};
  }
  var dataProvider = useDataProvider();
  var _b = options.onError, onError = _b === void 0 ? noop5 : _b, _c = options.onSuccess, onSuccess = _c === void 0 ? noop5 : _c, _d = options.onSettled, onSettled = _d === void 0 ? noop5 : _d, enabled = options.enabled, queryOptions2 = __rest16(options, ["onError", "onSuccess", "onSettled", "enabled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign25({
    // Sometimes the id comes as a string (e.g. when read from the URL in a Show view).
    // Sometimes the id comes as a number (e.g. when read from a Record in useGetList response).
    // As the react-query cache is type-sensitive, we always stringify the identifier to get a match
    queryKey: [resource, "getOne", { id: String(id), meta }],
    queryFn: function(queryParams) {
      return id == null ? Promise.reject("useGetOne: id cannot be null") : dataProvider.getOne(resource, {
        id,
        meta,
...
var useGetList = function(resource, params, options) {
  ...
  var _a12 = params.pagination, pagination = _a12 === void 0 ? { page: 1, perPage: 25 } : _a12, _b = params.sort, sort = _b === void 0 ? { field: "id", order: "DESC" } : _b, _c = params.filter, filter = _c === void 0 ? {} : _c, meta = params.meta;
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _d = options.onError, onError = _d === void 0 ? noop6 : _d, _e = options.onSuccess, onSuccess = _e === void 0 ? noop6 : _e, _f = options.onSettled, onSettled = _f === void 0 ? noop6 : _f, queryOptions2 = __rest17(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign26({ queryKey: [resource, "getList", { pagination, sort, filter, meta }], queryFn: function(queryParams) {
    return dataProvider.getList(resource, {
      ...
      var data = _a13.data, total = _a13.total, pageInfo = _a13.pageInfo, meta2 = _a13.meta;
      return {
        data,
        total,
        pageInfo,
  ...
  var metaValue = (0, import_react63.useRef)(meta);
  var resourceValue = (0, import_react63.useRef)(resource);
  ...
  (0, import_react63.useEffect)(function() {
    ...
    if (result.data === void 0 || result.error != null || result.isFetching)
      return;
    if (((_a13 = result.data) === null || _a13 === void 0 ? void 0 : _a13.data) && result.data.data.length <= MAX_DATA_LENGTH_TO_CACHE) {
  ...
  return (0, import_react63.useMemo)(function() {
    return result.data ? __assign26(__assign26({}, result), result.data) : result;
  }, [result]);
};
var noop6 = function() {
  return void 0;
...
var useGetMany = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.onError, onError = _a12 === void 0 ? noop7 : _a12, _b = options.onSuccess, onSuccess = _b === void 0 ? noop7 : _b, _c = options.onSettled, onSettled = _c === void 0 ? noop7 : _c, enabled = options.enabled, queryOptions2 = __rest18(options, ["onError", "onSuccess", "onSettled", "enabled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign27({ queryKey: [
    resource,
    "getMany",
    {
  ...
  var metaValue = (0, import_react64.useRef)(meta);
  var resourceValue = (0, import_react64.useRef)(resource);
...
var useGetManyAggregate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.onError, onError = _a12 === void 0 ? noop8 : _a12, _b = options.onSuccess, onSuccess = _b === void 0 ? noop8 : _b, _c = options.onSettled, onSettled = _c === void 0 ? noop8 : _c, enabled = options.enabled, queryOptions2 = __rest19(options, ["onError", "onSuccess", "onSettled", "enabled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var ids = params.ids, meta = params.meta;
  var placeholderData = (0, import_react65.useMemo)(function() {
  ...
  var result = useQuery(__assign28({ queryKey: [
    resource,
    "getMany",
    {
  ...
  var metaValue = (0, import_react65.useRef)(meta);
  var resourceValue = (0, import_react65.useRef)(resource);
  ...
  (0, import_react65.useEffect)(function() {
    ...
    if (result.data === void 0 || result.error != null || result.isFetching)
      return;
    ((_a13 = result.data) !== null && _a13 !== void 0 ? _a13 : []).forEach(function(record) {
      queryClient.setQueryData([
        resourceValue.current,
        "getOne",
        { id: String(record.id), meta: metaValue.current }
...
var batch = function(fn) {
  ...
  return function(arg) {
    ...
    timeout = setTimeout(function() {
      timeout = null;
      fn(__spreadArray13([], capturedArgs, true));
      capturedArgs = [];
    }, 0);
  };
};
var callGetManyQueries = batch(function(calls) {
  ...
  Object.keys(callsByResourceAndMeta).forEach(function(resource) {
    ...
    var uniqueResource = callsForResource.reduce(
      function(acc, _a12) {
        var resource2 = _a12.resource;
        return resource2 || acc;
      },
      ""
      // Should never happen as we always have a resource in callArgs but makes TS happy
    );
    var aggregatedIds = callsForResource.reduce(function(acc, _a12) {
      var ids2 = _a12.ids;
      return (0, import_union.default)(acc, ids2);
    }, []).filter(function(v) {
      return v != null && v !== "";
    });
    var uniqueMeta = callsForResource.reduce(function(acc, _a12) {
      var meta2 = _a12.meta;
      return meta2 || acc;
    }, void 0);
    if (aggregatedIds.length === 0) {
      callsForResource.forEach(function(_a12) {
        var resolve = _a12.resolve;
        resolve([]);
      });
      return;
    }
    var callThatHasAllAggregatedIds = callsForResource.find(function(_a12) {
      var ids2 = _a12.ids, signal2 = _a12.signal;
    ...
    if (callThatHasAllAggregatedIds) {
      ...
      dataProvider_1.getMany(resource_1, { ids, meta, signal }).then(function(_a12) {
        var data = _a12.data;
        return data;
      }).then(function(data) {
        callsForResource.forEach(function(_a12) {
          var ids2 = _a12.ids, resolve = _a12.resolve;
    ...
    queryClient.fetchQuery({
      ...
      queryFn: function(queryParams) {
        return dataProvider.getMany(uniqueResource, {
          ids: aggregatedIds,
          meta: uniqueMeta,
          signal: dataProvider.supportAbortSignal === true ? queryParams.signal : void 0
        }).then(function(_a12) {
      ...
      return callsForResource.forEach(function(_a12) {
        var reject = _a12.reject;
        return reject(error);
      });
    });
...
var useGetManyReference = function(resource, params, options) {
  ...
  var target = params.target, id = params.id, _a12 = params.pagination, pagination = _a12 === void 0 ? { page: 1, perPage: 25 } : _a12, _b = params.sort, sort = _b === void 0 ? { field: "id", order: "DESC" } : _b, _c = params.filter, filter = _c === void 0 ? {} : _c, meta = params.meta;
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _d = options.onError, onError = _d === void 0 ? noop9 : _d, _e = options.onSuccess, onSuccess = _e === void 0 ? noop9 : _e, _f = options.onSettled, onSettled = _f === void 0 ? noop9 : _f, queryOptions2 = __rest20(options, ["onError", "onSuccess", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign29({ queryKey: [
    resource,
    "getManyReference",
  ...
  (0, import_react66.useEffect)(function() {
    ...
    if (result.data === void 0)
      return;
    (_b2 = (_a13 = result.data) === null || _a13 === void 0 ? void 0 : _a13.data) === null || _b2 === void 0 ? void 0 : _b2.forEach(function(record) {
  ...
  return (0, import_react66.useMemo)(function() {
    return result.data ? __assign29(__assign29({}, result), result.data) : result;
  }, [result]);
};
var noop9 = function() {
  return void 0;
...
function useGetRecordId(recordId) {
  ...
  var actualRecordId = (_a12 = recordId !== null && recordId !== void 0 ? recordId : contextRecord === null || contextRecord === void 0 ? void 0 : contextRecord.id) !== null && _a12 !== void 0 ? _a12 : routeId;
...
var useCreate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = options.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions2 = __rest21(options, ["mutationMode", "getMutateWithMiddlewares"]);
  var dataProviderCreate = useEvent(function(resource2, params2) {
    return dataProvider.create(resource2, params2);
  });
  var _b = useMutationWithMutationMode(__assign30({ resource }, params), __assign30(__assign30({}, mutationOptions2), { mutationKey: [resource, "create", params], mutationMode, mutationFn: function(_a13) {
    var resource2 = _a13.resource, params2 = __rest21(_a13, ["resource"]);
    if (resource2 == null) {
    ...
    var resource2 = _a13.resource, params2 = __rest21(_a13, ["resource"]);
    var mutationMode2 = _b2.mutationMode;
    var id = mutationMode2 === "pessimistic" ? result === null || result === void 0 ? void 0 : result.id : (_c = params2.data) === null || _c === void 0 ? void 0 : _c.id;
    if (!id) {
      throw new Error("Invalid dataProvider response for create: missing id");
    }
    var now = Date.now();
    var updatedAt = mutationMode2 === "undoable" ? now + 5 * 1e3 : now;
    var clonedData = JSON.parse(JSON.stringify(mutationMode2 === "pessimistic" ? result : params2.data));
    queryClient.setQueryData([resource2, "getOne", { id: String(id), meta: params2.meta }], function(record) {
      return __assign30(__assign30({}, record), clonedData);
    }, { updatedAt });
    return clonedData;
  }, getQueryKeys: function(_a13, _b2) {
    var _c;
    var resource2 = _a13.resource, params2 = __rest21(_a13, ["resource"]);
    var mutationMode2 = _b2.mutationMode;
    var queryKeys = [
    ...
    if (mutationMode2 !== "pessimistic" && ((_c = params2.data) === null || _c === void 0 ? void 0 : _c.id)) {
      queryKeys.push([
        resource2,
        "getOne",
    ...
    if (getMutateWithMiddlewares) {
      ...
      return function(args) {
        var resource2 = args.resource, params2 = __rest21(args, ["resource"]);
        return mutateWithMiddlewares_1(resource2, params2);
      };
    }
    return function(args) {
  ...
  }, onUndo: function(_a13) {
    var resource2 = _a13.resource, data = _a13.data, meta = _a13.meta;
    queryClient.removeQueries({
      queryKey: [
        resource2,
        "getOne",
        { id: String(data === null || data === void 0 ? void 0 : data.id), meta }
      ],
      exact: true
    });
  }, onSettled: function(result, error, variables, context) {
  ...
  var create = useEvent(function(callTimeResource, callTimeParams, callTimeOptions) {
    ...
    return mutate(__assign30({ resource: callTimeResource }, callTimeParams), callTimeOptions);
  });
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _j = options.onSuccess, onSuccess = _j === void 0 ? noop10 : _j, _k = options.onError, onError = _k === void 0 ? noop10 : _k, _l = options.onSettled, onSettled = _l === void 0 ? noop10 : _l, queryOptions2 = __rest22(options, ["onSuccess", "onError", "onSettled"]);
  var onSuccessEvent = useEvent(onSuccess);
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useInfiniteQuery(__assign31(__assign31({ queryKey: [
    resource,
    "getInfiniteList",
    { pagination, sort, filter, meta }
  ], queryFn: function(queryParams) {
    var _a13 = queryParams.pageParam, pageParam = _a13 === void 0 ? pagination.page : _a13;
    return dataProvider.getList(resource, {
      pagination: {
        page: pageParam,
        perPage: pagination.perPage
      ...
      var data = _a14.data, pageInfo = _a14.pageInfo, total = _a14.total, meta2 = _a14.meta;
      return {
        data,
        total,
        pageParam,
  ...
  var metaValue = (0, import_react67.useRef)(meta);
  var resourceValue = (0, import_react67.useRef)(resource);
  ...
  return result.data ? __assign31(__assign31({}, result), { data: result.data, total: (_c = (_b = (_a12 = result.data) === null || _a12 === void 0 ? void 0 : _a12.pages[0]) === null || _b === void 0 ? void 0 : _b.total) !== null && _c !== void 0 ? _c : void 0, meta: (_e = (_d = result.data) === null || _d === void 0 ? void 0 : _d.pages[0]) === null || _e === void 0 ? void 0 : _e.meta }) : result;
};
var noop10 = function() {
  return void 0;
};
...
var TakeUndoableMutationContext = (0, import_react68.createContext)(function() {
});
...
var UndoableMutationsContextProvider = function(_a12) {
  var children = _a12.children;
  var _b = (0, import_react69.useState)([]), mutations = _b[0], setMutations = _b[1];
  var addMutation = (0, import_react69.useCallback)(function(mutation) {
    setMutations(function(mutations2) {
      return __spreadArray14(__spreadArray14([], mutations2, true), [mutation], false);
    });
  }, []);
  var takeMutation = (0, import_react69.useCallback)(function() {
  ...
  return React24.createElement(
    ...
    { value: takeMutation },
    React24.createElement(AddUndoableMutationContext.Provider, { value: addMutation }, children)
  );
};
...
var useTakeUndoableMutation = function() {
  return (0, import_react70.useContext)(TakeUndoableMutationContext);
};

// node_modules/ra-core/dist/esm/controller/saveContext/SaveContext.js
var import_react71 = __toESM(require_react());
var SaveContext = (0, import_react71.createContext)({});

// node_modules/ra-core/dist/esm/controller/saveContext/SaveContextProvider.js
var React25 = __toESM(require_react());
var SaveContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React25.createElement(SaveContext.Provider, { value }, children);
};
...
var usePickSaveContext = function(context) {
  var value = (0, import_react72.useMemo)(
    function() {
...
var useSaveContext = function(_props) {
  return (0, import_react73.useContext)(SaveContext);
};
...
var useMutationMiddlewares = function() {
  var callbacks = (0, import_react74.useRef)([]);
  var registerMutationMiddleware = (0, import_react74.useCallback)(function(callback) {
    callbacks.current.push(callback);
  }, []);
  var unregisterMutationMiddleware = (0, import_react74.useCallback)(function(callback) {
    callbacks.current = callbacks.current.filter(function(cb) {
      return cb !== callback;
    });
  }, []);
  var getMutateWithMiddlewares = (0, import_react74.useCallback)(function(fn) {
    var currentCallbacks = __spreadArray15([], callbacks.current, true);
    return function() {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
      ...
      var next = function() {
        ...
        index--;
        if (index >= 0) {
          return currentCallbacks[index].apply(currentCallbacks, __spreadArray15(__spreadArray15([], newArgs, false), [next], false));
        } else {
          return fn.apply(void 0, newArgs);
        }
      };
      if (currentCallbacks.length > 0) {
        return currentCallbacks[index].apply(currentCallbacks, __spreadArray15(__spreadArray15([], args, false), [next], false));
      }
      return fn.apply(void 0, args);
    };
  }, []);
  var functions = (0, import_react74.useMemo)(function() {
    return {
      registerMutationMiddleware,
...
var useRegisterMutationMiddleware = function(callback) {
  var _a12 = useSaveContext(), registerMutationMiddleware = _a12.registerMutationMiddleware, unregisterMutationMiddleware = _a12.unregisterMutationMiddleware;
...
var useCreateController = function(props) {
  ...
  var disableAuthentication = props.disableAuthentication, record = props.record, redirectTo = props.redirect, transform2 = props.transform, _a12 = props.mutationMode, mutationMode = _a12 === void 0 ? "pessimistic" : _a12, _b = props.mutationOptions, mutationOptions2 = _b === void 0 ? {} : _b;
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var notify = useNotify();
  var redirect = useRedirect();
  var onSuccess = mutationOptions2.onSuccess, onError = mutationOptions2.onError, meta = mutationOptions2.meta, otherMutationOptions = __rest23(mutationOptions2, ["onSuccess", "onError", "meta"]);
  ...
  var _e = useCreate(resource, void 0, __assign32(__assign32({ onSuccess: function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
    return __awaiter7(void 0, void 0, void 0, function() {
      ...
      return __generator7(this, function(_a13) {
        if (onSuccess) {
          return [2, onSuccess.apply(void 0, args)];
        }
        data = args[0];
    ...
    var error = args[0];
    var validationErrors = (_a13 = error === null || error === void 0 ? void 0 : error.body) === null || _a13 === void 0 ? void 0 : _a13.errors;
  ...
  } }, otherMutationOptions), { mutationMode, returnPromise: mutationMode === "pessimistic", getMutateWithMiddlewares })), create = _e[0], saving = _e[1].isPending;
  var save = (0, import_react76.useCallback)(function(data, _a13) {
    var _b2 = _a13 === void 0 ? {} : _a13, onSuccessFromSave = _b2.onSuccess, onErrorFromSave = _b2.onError, transformFromSave = _b2.transform, metaFromSave = _b2.meta;
      ...
      return __awaiter7(void 0, void 0, void 0, function() {
        ...
        return __generator7(this, function(_b3) {
          switch (_b3.label) {
            case 0:
              _b3.trys.push([0, 2, , 3]);
              return [4, create(resource, { data: data2, meta: metaFromSave !== null && metaFromSave !== void 0 ? metaFromSave : meta }, {
            ...
            case 2:
              error_1 = _b3.sent();
              if ((error_1 instanceof HttpError_default || typeof error_1 === "object" && error_1 !== null && error_1.hasOwnProperty("body")) && ((_a14 = error_1.body) === null || _a14 === void 0 ? void 0 : _a14.errors) != null) {
...
var CreateContext = (0, import_react77.createContext)(null);
...
var CreateContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React26.createElement(
    ...
    React26.createElement(
      SaveContextProvider,
      { value: __assign33(__assign33({}, usePickSaveContext(value)), { mutationMode: "pessimistic" }) },
...
var CreateBase = function(_a12) {
  var children = _a12.children, render = _a12.render, loading = _a12.loading, _b = _a12.authLoading, authLoading = _b === void 0 ? loading : _b, props = __rest24(_a12, ["children", "render", "loading", "authLoading"]);
  ...
  var showAuthLoading = isAuthPending && !props.disableAuthentication && authLoading !== false && authLoading !== void 0;
  return (
    // We pass props.resource here as we don't need to create a new ResourceContext if the props is not provided
    React27.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React27.createElement(CreateContextProvider, { value: controllerProps }, showAuthLoading ? authLoading : render ? render(controllerProps) : children)
    )
  );
};
...
var CreateController = function(_a12) {
  var children = _a12.children, props = __rest25(_a12, ["children"]);
  var controllerProps = useCreateController(props);
...
var useCreateContext = function() {
  var context = (0, import_react78.useContext)(CreateContext);
  if (!context) {
...
var useEditController = function(props) {
  ...
  var _a12 = props.disableAuthentication, disableAuthentication = _a12 === void 0 ? false : _a12, propsId = props.id, _b = props.mutationMode, mutationMode = _b === void 0 ? "undoable" : _b, _c = props.mutationOptions, mutationOptions2 = _c === void 0 ? {} : _c, _d = props.queryOptions, queryOptions2 = _d === void 0 ? {} : _d, _e = props.redirect, redirectTo = _e === void 0 ? DefaultRedirect : _e, _f = props.redirectOnError, redirectOnError = _f === void 0 ? DefaultRedirectOnError : _f, transform2 = props.transform;
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var queryMeta = queryOptions2.meta, otherQueryOptions = __rest26(queryOptions2, ["meta"]);
  var mutationMeta = mutationOptions2.meta, onSuccess = mutationOptions2.onSuccess, onError = mutationOptions2.onError, otherMutationOptions = __rest26(mutationOptions2, ["meta", "onSuccess", "onError"]);
  ...
  var _h = useGetOne(resource, { id, meta: queryMeta }, __assign34({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, onError: function() {
    notify("ra.notification.item_doesnt_exist", {
      type: "error"
    });
    redirect(redirectOnError, resource, id);
  }, refetchOnReconnect: false, refetchOnWindowFocus: false, retry: false }, otherQueryOptions)), record = _h.data, error = _h.error, isLoading = _h.isLoading, isFetching = _h.isFetching, isPaused = _h.isPaused, isPending = _h.isPending, isPlaceholderData = _h.isPlaceholderData, refetch2 = _h.refetch;
  ...
  var _j = useUpdate(resource, recordCached, __assign34(__assign34({ onSuccess: function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
    ...
    var error2 = args[0];
    var validationErrors = (_a13 = error2 === null || error2 === void 0 ? void 0 : error2.body) === null || _a13 === void 0 ? void 0 : _a13.errors;
    var hasValidationErrors = !!validationErrors && Object.keys(validationErrors).length > 0;
    if (!hasValidationErrors || mutationMode !== "pessimistic") {
  ...
  } }, otherMutationOptions), { mutationMode, returnPromise: mutationMode === "pessimistic", getMutateWithMiddlewares })), update = _j[0], saving = _j[1].isPending;
  var save = (0, import_react79.useCallback)(function(data, _a13) {
    var _b2 = _a13 === void 0 ? {} : _a13, onSuccessFromSave = _b2.onSuccess, onErrorFromSave = _b2.onError, transformFromSave = _b2.transform, metaFromSave = _b2.meta;
      ...
      return __awaiter8(void 0, void 0, void 0, function() {
        ...
        return __generator8(this, function(_b3) {
          switch (_b3.label) {
            ...
            case 2:
              error_1 = _b3.sent();
              if (((_a14 = error_1.body) === null || _a14 === void 0 ? void 0 : _a14.errors) != null) {
                return [2, error_1.body.errors];
              }
              return [3, 3];
            case 3:
...
var WithRecord = function(_a12) {
  var render = _a12.render, _b = _a12.empty, empty = _b === void 0 ? null : _b;
  var record = useRecordContext();
  return record ? React28.createElement(React28.Fragment, null, render(record)) : empty;
};

// node_modules/ra-core/dist/esm/controller/record/OptionalRecordContextProvider.js
var React29 = __toESM(require_react());
var OptionalRecordContextProvider = function(_a12) {
  var value = _a12.value, children = _a12.children;
  return value ? React29.createElement(RecordContextProvider, { value }, children) : children;
};
...
var RecordRepresentation = function(props) {
  ...
  var resource = useResourceContext(props);
  var getRecordRepresentation = useGetRecordRepresentation(resource);
  return React30.createElement(React30.Fragment, null, getRecordRepresentation(record));
};

// node_modules/ra-core/dist/esm/controller/edit/EditContext.js
var import_react80 = __toESM(require_react());
var EditContext = (0, import_react80.createContext)(null);
EditContext.displayName = "EditContext";

// node_modules/ra-core/dist/esm/controller/edit/EditContextProvider.js
var EditContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React31.createElement(
    ...
    React31.createElement(
      ...
      React31.createElement(RecordContextProvider, { value: value && value.record }, children)
    )
  );
};
...
var EditBase = function(_a12) {
  var authLoading = _a12.authLoading, loading = _a12.loading, offline = _a12.offline, error = _a12.error, redirectOnError = _a12.redirectOnError, children = _a12.children, render = _a12.render, props = __rest27(_a12, ["authLoading", "loading", "offline", "error", "redirectOnError", "children", "render"]);
  var hasError = error !== false && error !== void 0;
  var controllerProps = useEditController(__assign35(__assign35({}, props), { redirectOnError: redirectOnError !== null && redirectOnError !== void 0 ? redirectOnError : hasError ? false : void 0 }));
  var isAuthPending = useIsAuthPending({
    resource: controllerProps.resource,
    action: "edit"
  });
  ...
  var showAuthLoading = isAuthPending && !props.disableAuthentication && authLoading !== false && authLoading !== void 0;
  var showLoading = !isPaused && (!props.disableAuthentication && isAuthPending || isPending) && loading !== false && loading !== void 0;
  var showOffline = isPaused && isPending && offline !== false && offline !== void 0;
  ...
  return (
    ...
    React32.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React32.createElement(EditContextProvider, { value: controllerProps }, showAuthLoading ? authLoading : showLoading ? loading : showOffline ? offline : showError ? error : render ? render(controllerProps) : children)
    )
  );
};
...
var EditController = function(_a12) {
  var children = _a12.children, props = __rest28(_a12, ["children"]);
...
var useEditContext = function() {
  var context = (0, import_react81.useContext)(EditContext);
  if (!context) {
...
// node_modules/ra-core/dist/esm/controller/field/ReferenceOneFieldBase.js
...
var useReferenceOneFieldController = function(props) {
  var reference = props.reference, target = props.target, _a12 = props.source, source = _a12 === void 0 ? "id" : _a12, _b = props.sort, sort = _b === void 0 ? { field: "id", order: "ASC" } : _b, _c = props.filter, filter = _c === void 0 ? {} : _c, _d = props.queryOptions, queryOptions2 = _d === void 0 ? {} : _d;
  var record = useRecordContext(props);
  var notify = useNotify();
  var meta = queryOptions2.meta, otherQueryOptions = __rest29(queryOptions2, ["meta"]);
  var _e = useGetManyReference(reference, {
    target,
    id: (0, import_get4.default)(record, source),
    pagination: { page: 1, perPage: 1 },
    sort,
    filter,
    meta
  }, __assign36({ enabled: !!record, onError: function(error2) {
  ...
  } }, otherQueryOptions)), data = _e.data, error = _e.error, isFetching = _e.isFetching, isLoading = _e.isLoading, isPaused = _e.isPaused, isPending = _e.isPending, isPlaceholderData = _e.isPlaceholderData, refetch2 = _e.refetch;
  return {
...
var ReferenceFieldContext = (0, import_react82.createContext)(null);
var ReferenceFieldContextProvider = ReferenceFieldContext.Provider;
var useReferenceFieldContext = function() {
  var context = (0, import_react82.useContext)(ReferenceFieldContext);
  if (!context) {
...
var ReferenceOneFieldBase = function(props) {
  var children = props.children, render = props.render, record = props.record, reference = props.reference, _a12 = props.source, source = _a12 === void 0 ? "id" : _a12, target = props.target, empty = props.empty, error = props.error, loading = props.loading, sort = props.sort, filter = props.filter, link = props.link, offline = props.offline, queryOptions2 = props.queryOptions;
  ...
  var context = (0, import_react83.useMemo)(function() {
    return __assign37(__assign37({}, controllerProps), { link: path });
  ...
  var shouldRenderLoading = !isPaused && isPending && loading !== false && loading !== void 0;
  var shouldRenderOffline = isPaused && isPending && offline !== false && offline !== void 0;
  var shouldRenderError = !!controllerError && error !== false && error !== void 0;
  var shouldRenderEmpty = (!recordFromContext || !isPaused && referenceRecord == null && !controllerError && !isPending) && empty !== false && empty !== void 0;
  return import_react83.default.createElement(
    ...
    import_react83.default.createElement(
      ...
      { value: context },
      import_react83.default.createElement(RecordContextProvider, { value: referenceRecord }, shouldRenderLoading ? loading : shouldRenderOffline ? offline : shouldRenderError ? error : shouldRenderEmpty ? empty : render ? render(controllerProps) : children)
    )
  );
};
...
var useReference = function(_a12) {
  var reference = _a12.reference, id = _a12.id, _b = _a12.options, options = _b === void 0 ? {} : _b;
  var meta = options.meta, otherQueryOptions = __rest30(options, ["meta"]);
  var _c = useGetManyAggregate(reference, { ids: [id], meta }, otherQueryOptions), data = _c.data, error = _c.error, isLoading = _c.isLoading, isFetching = _c.isFetching, isPaused = _c.isPaused, isPending = _c.isPending, isPlaceholderData = _c.isPlaceholderData, refetch2 = _c.refetch;
  return {
...
var useReferenceFieldController = function(options) {
  ...
  var referenceRecordQuery = useReference({
    reference,
    id,
    options: __assign38(__assign38({}, queryOptions2), { enabled: ((queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) == null || (queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) === true) && id != null })
  });
  var path = useGetPathForRecord({
  ...
  var result = (0, import_react84.useMemo)(function() {
    return __assign38(__assign38({}, referenceRecordQuery), { link: path });
...
var ReferenceFieldBase = function(props) {
  ...
  var controllerError = controllerProps.error, isPending = controllerProps.isPending, isPaused = controllerProps.isPaused, referenceRecord = controllerProps.referenceRecord;
  var shouldRenderLoading = id != null && !isPaused && isPending && loading !== false && loading !== void 0;
  var shouldRenderOffline = isPaused && isPending && offline !== false && offline !== void 0;
  var shouldRenderError = !!controllerError && error !== false && error !== void 0;
  var shouldRenderEmpty = !isPaused && (!id || !referenceRecord && !controllerError && !isPending && empty !== false && empty !== void 0);
  return React34.createElement(
    ...
    React34.createElement(
      ...
      React34.createElement(RecordContextProvider, { value: referenceRecord }, shouldRenderLoading ? loading : shouldRenderOffline ? offline : shouldRenderError ? error : shouldRenderEmpty ? empty : render ? render(controllerProps) : children)
    )
  );
};

// node_modules/ra-core/dist/esm/controller/field/ReferenceManyCountBase.js
...
var useReferenceManyFieldController = function(props) {
  var _a12;
  var _b = props.debounce, debounce5 = _b === void 0 ? 500 : _b, reference = props.reference, target = props.target, _c = props.filter, filter = _c === void 0 ? defaultFilter2 : _c, _d = props.source, source = _d === void 0 ? "id" : _d, initialPage = props.page, initialPerPage = props.perPage, _e = props.sort, initialSort = _e === void 0 ? { field: "id", order: "DESC" } : _e, _f = props.queryOptions, queryOptions2 = _f === void 0 ? {} : _f;
  var notify = useNotify();
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var storeKey = (_a12 = props.storeKey) !== null && _a12 !== void 0 ? _a12 : "".concat(resource, ".").concat(record === null || record === void 0 ? void 0 : record.id, ".").concat(reference);
  ...
  var setSort = (0, import_react85.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  ...
  var filterRef = (0, import_react85.useRef)(filter);
  var _k = (0, import_react85.useState)({}), displayedFilters = _k[0], setDisplayedFilters = _k[1];
  var _l = (0, import_react85.useState)(filter), filterValues = _l[0], setFilterValues = _l[1];
  var hideFilter = (0, import_react85.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a13 = previousState, _b2 = filterName, _ = _a13[_b2], newState = __rest31(_a13, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
  ...
  var showFilter = (0, import_react85.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a13;
      return __assign39(__assign39({}, previousState), (_a13 = {}, _a13[filterName] = true, _a13));
    });
    setFilterValues(function(previousState) {
      var _a13;
      return __assign39(__assign39({}, previousState), (_a13 = {}, _a13[filterName] = defaultValue, _a13));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var debouncedSetFilters = (0, import_react85.useCallback)((0, import_debounce3.default)(function(filters, displayedFilters2) {
  ...
  var setFilters = (0, import_react85.useCallback)(function(filters, displayedFilters2, debounce6) {
    if (debounce6 === void 0) {
      debounce6 = false;
    }
    if (debounce6) {
  ...
  (0, import_react85.useEffect)(function() {
    if (!(0, import_isEqual2.default)(filter, filterRef.current)) {
      filterRef.current = filter;
      setFilterValues(filter);
    }
  }, [filter]);
  var recordValue = (0, import_get5.default)(record, source);
  var _m = useGetManyReference(reference, {
    ...
    filter: filterValues,
    meta
  }, __assign39({ enabled: recordValue != null, placeholderData: function(previousData) {
    return previousData;
  ...
  } }, otherQueryOptions)), data = _m.data, total = _m.total, responseMeta = _m.meta, pageInfo = _m.pageInfo, error = _m.error, isFetching = _m.isFetching, isLoading = _m.isLoading, isPaused = _m.isPaused, isPending = _m.isPending, isPlaceholderData = _m.isPlaceholderData, refetch2 = _m.refetch;
  var onSelectAll = useEvent(function() {
    var args_1 = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args_1[_i] = arguments[_i];
    }
    return __awaiter9(void 0, __spreadArray16([], args_1, true), void 0, function(_a13) {
      var meta2, onSuccess, onError, results, allIds, error_1;
      var _b2;
      var _c2 = _a13 === void 0 ? {} : _a13, _d2 = _c2.limit, limit = _d2 === void 0 ? 250 : _d2, _e2 = _c2.queryOptions, queryOptions3 = _e2 === void 0 ? {} : _e2;
      return __generator9(this, function(_f2) {
        switch (_f2.label) {
          case 0:
          ...
          case 2:
            results = _f2.sent();
            allIds = ((_b2 = results.data) === null || _b2 === void 0 ? void 0 : _b2.map(function(_a14) {
              var id = _a14.id;
              return id;
            })) || [];
...
function useSafeSetState(initialState2) {
  var _a12 = (0, import_react86.useState)(initialState2), state = _a12[0], setState = _a12[1];
  var mountedRef = (0, import_react86.useRef)(false);
  ...
  var safeSetState = (0, import_react86.useCallback)(function(args) {
    if (mountedRef.current) {
...
function useDeepCompareEffect(callback, inputs) {
  var cleanupRef = (0, import_react86.useRef)();
  (0, import_react86.useEffect)(function() {
...
function useTimeout(ms, key) {
  ...
  var _a12 = (0, import_react86.useState)(false), ready = _a12[0], setReady = _a12[1];
  (0, import_react86.useEffect)(function() {
    setReady(false);
...
function useIsMounted() {
  var isMounted = (0, import_react86.useRef)(true);
  (0, import_react86.useEffect)(function() {
...
var ReferenceManyCountBase = function(props) {
  var loading = props.loading, error = props.error, offline = props.offline, _a12 = props.timeout, timeout = _a12 === void 0 ? 1e3 : _a12, rest = __rest32(props, ["loading", "error", "offline", "timeout"]);
  var oneSecondHasPassed = useTimeout(timeout);
  var _b = useReferenceManyFieldController(__assign40(__assign40({}, rest), { page: 1, perPage: 1 })), isPaused = _b.isPaused, isPending = _b.isPending, fetchError = _b.error, total = _b.total;
  var shouldRenderLoading = isPending && !isPaused && loading !== void 0 && loading !== false;
  var shouldRenderOffline = isPending && isPaused && offline !== void 0 && offline !== false;
  var shouldRenderError = !isPending && fetchError && error !== void 0 && error !== false;
  return import_react87.default.createElement(import_react87.default.Fragment, null, shouldRenderLoading ? oneSecondHasPassed ? loading : null : shouldRenderOffline ? offline : shouldRenderError ? error : total);
};

// node_modules/ra-core/dist/esm/controller/field/ReferenceManyFieldBase.js
...
var ListFilterContext = (0, import_react88.createContext)(void 0);
...
var ListSortContext = (0, import_react89.createContext)(void 0);
...
var ListPaginationContext = (0, import_react90.createContext)(void 0);
...
// node_modules/ra-core/dist/esm/controller/list/ListContextProvider.js
var ListContextProvider = function(_a12) {
  var value = _a12.value, children = _a12.children;
  return React36.createElement(
    ...
    React36.createElement(
      ...
      React36.createElement(
        ...
        React36.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var ReferenceManyFieldBase = function(props) {
  var children = props.children, render = props.render, debounce5 = props.debounce, empty = props.empty, error = props.error, loading = props.loading, _a12 = props.filter, filter = _a12 === void 0 ? defaultFilter3 : _a12, offline = props.offline, _b = props.page, page = _b === void 0 ? 1 : _b, _c = props.perPage, perPage = _c === void 0 ? 25 : _c, record = props.record, reference = props.reference, resource = props.resource, _d = props.sort, sort = _d === void 0 ? defaultSort2 : _d, _e = props.source, source = _e === void 0 ? "id" : _e, storeKey = props.storeKey, target = props.target, queryOptions2 = props.queryOptions;
  ...
  var data = controllerProps.data, controllerError = controllerProps.error, filterValues = controllerProps.filterValues, hasNextPage2 = controllerProps.hasNextPage, hasPreviousPage2 = controllerProps.hasPreviousPage, isPaused = controllerProps.isPaused, isPending = controllerProps.isPending, isPlaceholderData = controllerProps.isPlaceholderData, total = controllerProps.total;
  var shouldRenderLoading = isPending && !isPaused && loading !== false && loading !== void 0;
  var shouldRenderOffline = isPaused && (isPending || isPlaceholderData) && offline !== false && offline !== void 0;
  var shouldRenderError = controllerError && error !== false && error !== void 0;
  var shouldRenderEmpty = empty !== false && empty !== void 0 && // there is no error
  ...
  return import_react91.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react91.default.createElement(ListContextProvider, { value: controllerProps }, shouldRenderLoading ? loading : shouldRenderOffline ? offline : shouldRenderError ? error : shouldRenderEmpty ? empty : render ? render(controllerProps) : children)
  );
};
var defaultFilter3 = {};
var defaultSort2 = { field: "id", order: "DESC" };

// node_modules/ra-core/dist/esm/controller/field/ReferenceArrayFieldBase.js
...
// node_modules/ra-core/dist/esm/controller/list/FilterContext.js
var React38 = __toESM(require_react());
var FilterContext = React38.createContext(void 0);
...
var ExporterContext = (0, import_react92.createContext)(defaultExporter);
...
var fetchRelatedRecords = function(dataProvider) {
  return function(data, field, resource) {
    return dataProvider.getMany(resource, { ids: getRelatedIds(data, field) }).then(function(_a12) {
      var data2 = _a12.data;
...
// node_modules/ra-core/dist/esm/export/useBulkExport.js
...
function useBulkExport(options) {
  ...
  var _a12 = useListContext(), exporterFromContext = _a12.exporter, selectedIds = _a12.selectedIds;
  var exporter = customExporter || exporterFromContext;
  var dataProvider = useDataProvider();
  var notify = useNotify();
  return (0, import_react93.useCallback)(function() {
    if (exporter && resource) {
      dataProvider.getMany(resource, { ids: selectedIds, meta }).then(function(_a13) {
        var data = _a13.data;
...
var useListParams = function(_a12) {
  var _b = _a12.debounce, debounce5 = _b === void 0 ? 500 : _b, _c = _a12.disableSyncWithLocation, disableSyncWithLocation = _c === void 0 ? false : _c, filterDefaultValues = _a12.filterDefaultValues, _d = _a12.perPage, perPage = _d === void 0 ? 10 : _d, resource = _a12.resource, _e = _a12.sort, sort = _e === void 0 ? defaultSort3 : _e, _f = _a12.storeKey, storeKey = _f === void 0 ? disableSyncWithLocation ? false : "".concat(resource, ".listParams") : _f;
  var location = useLocation();
  var navigate = useNavigate();
  var _g = (0, import_react94.useState)(defaultParams), localParams = _g[0], setLocalParams = _g[1];
  var _h = useStore(storeKey || "".concat(resource, ".listParams"), defaultParams), params = _h[0], setParams = _h[1];
  var tempParams = (0, import_react94.useRef)();
  ...
  var query = (0, import_react94.useMemo)(
    function() {
      return getQuery({
        queryFromLocation,
  ...
  var changeParams = (0, import_react94.useCallback)(function(action) {
    ...
    if (!tempParams.current) {
      ...
      setTimeout(function() {
        ...
        if (disableSyncWithLocation && !storeKey) {
          ...
          navigate({
            search: "?".concat((0, import_query_string2.stringify)(__assign41(__assign41({}, tempParams.current), { filter: JSON.stringify(tempParams.current.filter), displayedFilters: JSON.stringify(tempParams.current.displayedFilters) })))
          }, {
            state: {
  ...
  }, __spreadArray17(__spreadArray17([], requestSignature, true), [navigate], false));
  var setSort = (0, import_react94.useCallback)(function(sort2) {
    return changeParams({
      type: SET_SORT,
      payload: sort2
    });
  }, [changeParams]);
  var setPage = (0, import_react94.useCallback)(function(newPage) {
    return changeParams({ type: SET_PAGE, payload: newPage });
  }, [changeParams]);
  var setPerPage = (0, import_react94.useCallback)(function(newPerPage) {
  ...
  var debouncedSetFilters = (0, import_debounce4.default)(function(filter, displayedFilters) {
    changeParams({
      type: SET_FILTER,
      payload: {
  ...
  var setFilters = (0, import_react94.useCallback)(
  ...
  var hideFilter = (0, import_react94.useCallback)(function(filterName) {
    changeParams({
      type: HIDE_FILTER,
      payload: filterName
    });
  }, [changeParams]);
  var showFilter = (0, import_react94.useCallback)(function(filterName, defaultValue) {
    changeParams({
      type: SHOW_FILTER,
      payload: {
        filterName,
  ...
  return [
    __assign41(__assign41({ filterValues, requestSignature }, query), { displayedFilters: displayedFilterValues }),
    {
      changeParams,
      setPage,
      setPerPage,
...
var parseQueryFromLocation = function(_a12) {
  var search = _a12.search;
...
var getQuery = function(_a12) {
  var queryFromLocation = _a12.queryFromLocation, params = _a12.params, filterDefaultValues = _a12.filterDefaultValues, sort = _a12.sort, perPage = _a12.perPage;
  var query = Object.keys(queryFromLocation).length > 0 ? queryFromLocation : hasCustomParams(params) ? __assign41({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
  ...
  return __assign41(__assign41({}, query), { page: getNumberOrDefault(query.page, 1), perPage: getNumberOrDefault(query.perPage, 10) });
};
...
var useSelectAll = function(params) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var _a12 = useRecordSelection({ resource }), select = _a12[1].select;
  var notify = useNotify();
  var handleSelectAll = useEvent(function() {
    ...
    return __awaiter10(void 0, __spreadArray18([], args_1, true), void 0, function(_a13) {
      var meta, onSuccess, onError, otherQueryOptions, results, allIds, error_1;
      var _b;
      var _c = _a13 === void 0 ? {} : _a13, _d = _c.queryOptions, queryOptions2 = _d === void 0 ? {} : _d, _e = _c.limit, limit = _e === void 0 ? 250 : _e;
      return __generator10(this, function(_f) {
        switch (_f.label) {
          case 0:
            meta = queryOptions2.meta, onSuccess = queryOptions2.onSuccess, onError = queryOptions2.onError, otherQueryOptions = __rest33(queryOptions2, ["meta", "onSuccess", "onError"]);
            _f.label = 1;
          case 1:
            _f.trys.push([1, 3, , 4]);
            return [4, queryClient.fetchQuery(__assign42({ queryKey: [
              resource,
              "getList",
              {
                pagination: { page: 1, perPage: limit },
          ...
          case 2:
            results = _f.sent();
            allIds = ((_b = results.data) === null || _b === void 0 ? void 0 : _b.map(function(_a14) {
              var id = _a14.id;
              return id;
            })) || [];
            select(allIds);
...
var useInfiniteListController = function(props) {
  ...
  if (filter && (0, import_react95.isValidElement)(filter)) {
  ...
  var _j = useInfiniteGetList(resource, {
    ...
    filter: __assign43(__assign43({}, query.filter), filter),
    meta
  }, __assign43({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, placeholderData: function(previousData) {
    return previousData;
  ...
  var unwrappedData = (0, import_react95.useMemo)(function() {
    var _a13;
    return (_a13 = data === null || data === void 0 ? void 0 : data.pages) === null || _a13 === void 0 ? void 0 : _a13.reduce(function(acc, page) {
      return __spreadArray19(__spreadArray19([], acc, true), page.data, true);
    }, []);
  }, [data]);
  return {
    sort: currentSort,
...
var InfinitePaginationContext = (0, import_react96.createContext)({
  hasNextPage: false,
...
var InfiniteListBase = function(_a12) {
  var authLoading = _a12.authLoading, loading = _a12.loading, offline = _a12.offline, error = _a12.error, children = _a12.children, render = _a12.render, props = __rest35(_a12, ["authLoading", "loading", "offline", "error", "children", "render"]);
  ...
  var showAuthLoading = isAuthPending && !props.disableAuthentication && authLoading !== false && authLoading !== void 0;
  var showLoading = !isPaused && (!props.disableAuthentication && isAuthPending || isPending) && loading !== false && loading !== void 0;
  var showOffline = isPaused && // If isPending and isPaused are true, we are offline and couldn't even load the initial data
  ...
  var showError = errorState && error !== false && error !== void 0;
  return (
    // We pass props.resource here as we don't need to create a new ResourceContext if the props is not provided
    React39.createElement(
      ...
      React39.createElement(
        ListContextProvider,
        { value: controllerProps },
        React39.createElement(InfinitePaginationContext.Provider, { value: {
...
var useListController = function(props) {
  ...
  var _a12 = props.debounce, debounce5 = _a12 === void 0 ? 500 : _a12, _b = props.disableAuthentication, disableAuthentication = _b === void 0 ? false : _b, _c = props.disableSyncWithLocation, disableSyncWithLocation = _c === void 0 ? false : _c, _d = props.exporter, exporter = _d === void 0 ? defaultExporter : _d, filter = props.filter, filterDefaultValues = props.filterDefaultValues, _e = props.perPage, perPage = _e === void 0 ? 10 : _e, _f = props.queryOptions, queryOptions2 = _f === void 0 ? {} : _f, _g = props.sort, sort = _g === void 0 ? defaultSort4 : _g, storeKey = props.storeKey;
  var resource = useResourceContext(props);
  ...
  if (filter && ((0, import_react97.isValidElement)(filter) || Array.isArray(filter) && filter.some(import_react97.isValidElement))) {
  ...
  var _k = useGetList(resource, {
    ...
    sort: { field: query.sort, order: query.order },
    filter: __assign44(__assign44({}, query.filter), filter),
    meta
  }, __assign44({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, placeholderData: function(previousData) {
    return previousData;
  }, retry: false, onError: function(error2) {
    return notify((error2 === null || error2 === void 0 ? void 0 : error2.message) || "ra.notification.http_error", {
      type: "error",
  ...
  } }, otherQueryOptions)), data = _k.data, pageInfo = _k.pageInfo, total = _k.total, responseMeta = _k.meta, error = _k.error, isLoading = _k.isLoading, isFetching = _k.isFetching, isPending = _k.isPending, refetch2 = _k.refetch, isPaused = _k.isPaused, isPlaceholderData = _k.isPlaceholderData;
  ...
  var currentSort = (0, import_react97.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
...
var getListControllerProps = function(props) {
  return injectedProps.reduce(function(acc, key) {
    var _a12;
    return __assign44(__assign44({}, acc), (_a12 = {}, _a12[key] = props[key], _a12));
  }, {});
};
...
var ListBase = function(_a12) {
  var children = _a12.children, emptyWhileLoading = _a12.emptyWhileLoading, authLoading = _a12.authLoading, loading = _a12.loading, offline = _a12.offline, error = _a12.error, render = _a12.render, props = __rest37(_a12, ["children", "emptyWhileLoading", "authLoading", "loading", "offline", "error", "render"]);
  ...
  return (
    ...
    React40.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React40.createElement(ListContextProvider, { value: controllerProps }, showAuthLoading ? authLoading : showLoading ? loading : showOffline ? offline : showError ? error : showEmpty ? null : render ? render(controllerProps) : children)
    )
  );
};
...
var ListController = function(_a12) {
  var children = _a12.children, props = __rest38(_a12, ["children"]);
  var controllerProps = useListController(props);
  return children(controllerProps);
};

// node_modules/ra-core/dist/esm/controller/list/RecordsIterator.js
...
var useListContextWithProps = function(props) {
  var context = (0, import_react98.useContext)(ListContext);
...
var extractListContextProps = function(_a12) {
  var sort = _a12.sort, data = _a12.data, defaultTitle = _a12.defaultTitle, displayedFilters = _a12.displayedFilters, exporter = _a12.exporter, filterValues = _a12.filterValues, hasCreate = _a12.hasCreate, hideFilter = _a12.hideFilter, isFetching = _a12.isFetching, isLoading = _a12.isLoading, isPending = _a12.isPending, onSelect = _a12.onSelect, onSelectAll = _a12.onSelectAll, onToggleItem = _a12.onToggleItem, onUnselectItems = _a12.onUnselectItems, page = _a12.page, perPage = _a12.perPage, refetch2 = _a12.refetch, resource = _a12.resource, selectedIds = _a12.selectedIds, setFilters = _a12.setFilters, setPage = _a12.setPage, setPerPage = _a12.setPerPage, setSort = _a12.setSort, showFilter = _a12.showFilter, total = _a12.total;
  return {
    sort,
    data,
    defaultTitle,
...
var RecordsIterator = function(props) {
  ...
  var _a12 = useListContextWithProps(props), data = _a12.data, total = _a12.total, isPending = _a12.isPending, error = _a12.error;
  ...
  return React41.createElement(React41.Fragment, null, data.map(function(record, index) {
    var _a13;
    return React41.createElement(RecordContextProvider, { key: (_a13 = record.id) !== null && _a13 !== void 0 ? _a13 : "row".concat(index), value: record }, render ? render(record, index) : children);
  }));
};
...
var useExpanded = function(resource, id, single) {
  ...
  var _a12 = useStore("".concat(resource, ".datagrid.expanded"), []), expandedIds = _a12[0], setExpandedIds = _a12[1];
  ...
  var toggleExpanded = (0, import_react99.useCallback)(function() {
    setExpandedIds(function(ids) {
      ...
      return index > -1 ? single ? [] : __spreadArray20(__spreadArray20([], ids.slice(0, index), true), ids.slice(index + 1), true) : single ? [id] : __spreadArray20(__spreadArray20([], ids, true), [id], false);
    });
...
var useExpandAll = function(resource, ids) {
  ...
  var toggleExpandedAll = (0, import_react99.useCallback)(function() {
...
// node_modules/ra-core/dist/esm/controller/list/useFilterContext.js
var import_react100 = __toESM(require_react());
var useFilterContext = function() {
  return (0, import_react100.useContext)(FilterContext);
};
...
var useInfinitePaginationContext = function() {
  return (0, import_react101.useContext)(InfinitePaginationContext);
};
...
var useList = function(props) {
  var _a12;
  var data = props.data, error = props.error, _b = props.filter, filter = _b === void 0 ? defaultFilter4 : _b, _c = props.isFetching, isFetching = _c === void 0 ? false : _c, _d = props.isLoading, isLoading = _d === void 0 ? false : _d, _e = props.isPaused, isPaused = _e === void 0 ? false : _e, _f = props.isPending, isPending = _f === void 0 ? false : _f, _g = props.isPlaceholderData, isPlaceholderData = _g === void 0 ? false : _g, _h = props.page, initialPage = _h === void 0 ? 1 : _h, _j = props.perPage, initialPerPage = _j === void 0 ? 1e3 : _j, initialSort = props.sort, _k = props.filterCallback, filterCallback = _k === void 0 ? function(record) {
    return Boolean(record);
  } : _k;
  var resource = useResourceContext(props);
  var _l = (0, import_react102.useState)(function() {
    return {
      data,
      total: data ? data.length : void 0
    };
  }), finalItems = _l[0], setFinalItems = _l[1];
  var _m = usePaginationState_default({
    page: initialPage,
    perPage: initialPerPage
  }), page = _m.page, setPage = _m.setPage, perPage = _m.perPage, setPerPage = _m.setPerPage;
  var _o = useSortState_default(initialSort), sort = _o.sort, setSortState = _o.setSort;
  var setSort = (0, import_react102.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  }, [setPage, setSortState]);
  ...
  var filterRef = (0, import_react102.useRef)(filter);
  var _q = (0, import_react102.useState)({}), displayedFilters = _q[0], setDisplayedFilters = _q[1];
  var _r = (0, import_react102.useState)(filter), filterValues = _r[0], setFilterValues = _r[1];
  var hideFilter = (0, import_react102.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a13 = previousState, _b2 = filterName, _ = _a13[_b2], newState = __rest39(_a13, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
    setFilterValues(function(previousState) {
      var _a13 = previousState, _b2 = filterName, _ = _a13[_b2], newState = __rest39(_a13, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
  ...
  var showFilter = (0, import_react102.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a13;
      return __assign45(__assign45({}, previousState), (_a13 = {}, _a13[filterName] = true, _a13));
    });
    setFilterValues(function(previousState) {
      var _a13;
      return removeEmpty_default(__assign45(__assign45({}, previousState), (_a13 = {}, _a13[filterName] = defaultValue, _a13)));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var setFilters = (0, import_react102.useCallback)(function(filters, displayedFilters2) {
    ...
    function() {
      ...
      if (filterValues) {
        ...
        tempData = data.filter(function(record) {
          return Object.entries(flattenFilterValues_1).every(function(_a13) {
            var filterName = _a13[0], filterValue = _a13[1];
            var recordValue = (0, import_get6.default)(record, filterName);
      ...
      if (sort.field) {
        tempData = tempData.sort(function(a, b) {
          if ((0, import_get6.default)(a, sort.field) > (0, import_get6.default)(b, sort.field)) {
  ...
  var onSelectAll = (0, import_react102.useCallback)(function() {
    var allIds = (data === null || data === void 0 ? void 0 : data.map(function(_a13) {
      var id = _a13.id;
      return id;
    })) || [];
    selectionModifiers.select(allIds);
  ...
  return {
    sort,
    data: isPending ? void 0 : (_a12 = finalItems === null || finalItems === void 0 ? void 0 : finalItems.data) !== null && _a12 !== void 0 ? _a12 : [],
    defaultTitle: "",
...
var useListFilterContext = function() {
  var context = (0, import_react103.useContext)(ListFilterContext);
  if (!context) {
...
var useListPaginationContext = function() {
  var context = (0, import_react104.useContext)(ListPaginationContext);
  if (!context) {
...
var useListSortContext = function() {
  var context = (0, import_react105.useContext)(ListSortContext);
  if (!context) {
...
var useUnselectAll = function(resource) {
  var _a12 = useRecordSelection(resource ? { resource } : { disableSyncWithStore: true }), clearSelection = _a12[1].clearSelection;
...
var WithListContext = function(_a12) {
  var empty = _a12.empty, loading = _a12.loading, offline = _a12.offline, error = _a12.error, render = _a12.render, children = _a12.children, props = __rest40(_a12, ["empty", "loading", "offline", "error", "render", "children"]);
...
var useReferenceArrayFieldController = function(props) {
  var _a12 = props.filter, filter = _a12 === void 0 ? defaultFilter5 : _a12, _b = props.page, page = _b === void 0 ? 1 : _b, _c = props.perPage, perPage = _c === void 0 ? 1e3 : _c, record = props.record, reference = props.reference, sort = props.sort, source = props.source, _d = props.queryOptions, queryOptions2 = _d === void 0 ? {} : _d;
  var notify = useNotify();
  var value = (0, import_get7.default)(record, source);
  var meta = queryOptions2.meta, otherQueryOptions = __rest41(queryOptions2, ["meta"]);
  var ids = Array.isArray(value) ? value : emptyArray;
  var _e = useGetManyAggregate(reference, { ids, meta }, __assign46({ onError: function(error2) {
    return notify(typeof error2 === "string" ? error2 : (error2 === null || error2 === void 0 ? void 0 : error2.message) || "ra.notification.http_error", {
      type: "error",
      messageArgs: {
        _: typeof error2 === "string" ? error2 : (error2 === null || error2 === void 0 ? void 0 : error2.message) ? error2.message : void 0
  ...
  } }, otherQueryOptions)), data = _e.data, error = _e.error, isLoading = _e.isLoading, isFetching = _e.isFetching, isPaused = _e.isPaused, isPending = _e.isPending, isPlaceholderData = _e.isPlaceholderData, refetch2 = _e.refetch;
  ...
  return __assign46(__assign46({}, listProps), { defaultTitle: void 0, refetch: refetch2, resource: reference });
};

// node_modules/ra-core/dist/esm/controller/field/ReferenceArrayFieldBase.js
var ReferenceArrayFieldBase = function(props) {
  var children = props.children, render = props.render, error = props.error, loading = props.loading, empty = props.empty, filter = props.filter, offline = props.offline, _a12 = props.page, page = _a12 === void 0 ? 1 : _a12, perPage = props.perPage, reference = props.reference, resource = props.resource, sort = props.sort, source = props.source, queryOptions2 = props.queryOptions;
  var record = useRecordContext(props);
  ...
  var shouldRenderLoading = isPending && !isPaused && loading !== void 0 && loading !== false;
  var shouldRenderOffline = isPaused && (isPending || isPlaceholderData) && offline !== void 0 && offline !== false;
  var shouldRenderError = !isPending && !isPaused && controllerError && error !== void 0 && error !== false;
  var shouldRenderEmpty = (
  ...
  return React42.createElement(
    ResourceContextProvider,
    { value: reference },
    React42.createElement(ListContextProvider, { value: controllerProps }, shouldRenderLoading ? loading : shouldRenderOffline ? offline : shouldRenderError ? error : shouldRenderEmpty ? empty : render ? render(controllerProps) : children)
  );
};

// node_modules/ra-core/dist/esm/controller/field/sanitizeFieldRestProps.js
...
var getStatusForInput = function(_a12) {
  var field = _a12.field, matchingReferences = _a12.matchingReferences, referenceRecord = _a12.referenceRecord, _b = _a12.translate, translate = _b === void 0 ? function(x) {
    return x;
  } : _b;
...
var getStatusForArrayInput = function(_a12) {
  var field = _a12.field, matchingReferences = _a12.matchingReferences, referenceRecords = _a12.referenceRecords, _b = _a12.translate, translate = _b === void 0 ? function(x) {
    return x;
  } : _b;
...
var useReferenceParams = function(_a12) {
  var resource = _a12.resource, filter = _a12.filter, _b = _a12.sort, sort = _b === void 0 ? defaultSort5 : _b, _c = _a12.page, page = _c === void 0 ? 1 : _c, _d = _a12.perPage, perPage = _d === void 0 ? 10 : _d, _e = _a12.debounce, debounce5 = _e === void 0 ? 500 : _e;
  var _f = (0, import_react107.useState)(defaultParams2), params = _f[0], setParams = _f[1];
  var tempParams = (0, import_react107.useRef)();
  var requestSignature = [
    resource,
  ...
  var query = (0, import_react107.useMemo)(
    function() {
      return getQuery2({
        params,
  ...
  var changeParams = (0, import_react107.useCallback)(function(action) {
    if (!tempParams.current) {
  ...
  var setSort = (0, import_react107.useCallback)(
    function(sort2) {
      return changeParams({
        type: SET_SORT,
        payload: sort2
  ...
  var setPage = (0, import_react107.useCallback)(
    function(newPage) {
      return changeParams({ type: SET_PAGE, payload: newPage });
    },
    requestSignature
  ...
  var setPerPage = (0, import_react107.useCallback)(
    function(newPerPage) {
      return changeParams({ type: SET_PER_PAGE, payload: newPerPage });
    },
    requestSignature
  ...
  var debouncedSetFilters = (0, import_react107.useRef)((0, import_debounce5.default)(function(filter2, displayedFilters) {
    if (displayedFilters === void 0) {
      displayedFilters = void 0;
    }
    changeParams({
  ...
  var setFilters = (0, import_react107.useCallback)(
  ...
  var hideFilter = (0, import_react107.useCallback)(function(filterName) {
    changeParams({
      type: HIDE_FILTER,
      payload: filterName
    });
  }, requestSignature);
  var showFilter = (0, import_react107.useCallback)(function(filterName, defaultValue) {
    changeParams({
      type: SHOW_FILTER,
      payload: {
        filterName,
  ...
  return [
    __assign47(__assign47({ filterValues, requestSignature }, query), { displayedFilters: displayedFilterValues }),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery2 = function(_a12) {
  var params = _a12.params, filterDefaultValues = _a12.filterDefaultValues, sort = _a12.sort, page = _a12.page, perPage = _a12.perPage;
  var query = hasCustomParams2(params) ? __assign47({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
    query.sort = sort.field;
    query.order = sort.order;
  }
  ...
  return __assign47(__assign47({}, query), { page: getNumberOrDefault2(query.page, 1), perPage: getNumberOrDefault2(query.perPage, 10) });
};
...
var useReferenceArrayInputController = function(props) {
  ...
  var value = (_a12 = useWatch({ name: finalSource })) !== null && _a12 !== void 0 ? _a12 : getValues2(finalSource);
  var meta = queryOptions2.meta, otherQueryOptions = __rest43(queryOptions2, ["meta"]);
  ...
  var _h = useGetList(reference, {
    ...
    filter: __assign48(__assign48({}, params.filter), filter),
    meta
  }, __assign48({ retry: false, enabled: isGetMatchingEnabled, placeholderData: function(previousData) {
    return previousData;
  } }, otherQueryOptions)), matchingReferences = _h.data, total = _h.total, pageInfo = _h.pageInfo, errorGetList = _h.error, isLoadingGetList = _h.isLoading, isFetchingGetList = _h.isFetching, isPausedGetList = _h.isPaused, isPendingGetList = _h.isPending, isPlaceholderDataGetList = _h.isPlaceholderData, refetchGetMatching = _h.refetch;
  ...
  var refetch2 = (0, import_react108.useCallback)(function() {
    refetchGetMany();
    refetchGetMatching();
  }, [refetchGetMany, refetchGetMatching]);
  var currentSort = (0, import_react108.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var mergeReferences = function(ref1, ref2) {
  var res = __spreadArray21([], ref1, true);
...
var useReferenceInputController = function(props) {
  var debounce5 = props.debounce, enableGetChoices = props.enableGetChoices, filter = props.filter, _a12 = props.page, initialPage = _a12 === void 0 ? 1 : _a12, _b = props.perPage, initialPerPage = _b === void 0 ? 25 : _b, initialSort = props.sort, _c = props.queryOptions, queryOptions2 = _c === void 0 ? {} : _c, reference = props.reference, source = props.source;
  var meta = queryOptions2.meta, otherQueryOptions = __rest44(queryOptions2, ["meta"]);
  ...
  var _g = (0, import_react109.useState)(void 0), referenceRecord = _g[0], setReferenceRecord = _g[1];
  (0, import_react109.useEffect)(function() {
    setReferenceRecord(currentReferenceRecord);
  }, [currentReferenceRecord]);
  var _h = (0, import_react109.useMemo)(function() {
    ...
    if (referenceRecord == null || possibleValuesData == null || (possibleValuesData !== null && possibleValuesData !== void 0 ? possibleValuesData : []).find(function(record) {
      return record.id === referenceRecord.id;
    })) {
      var finalData_1 = possibleValuesData !== null && possibleValuesData !== void 0 ? possibleValuesData : [];
      if (referenceRecord && finalData_1.find(function(r) {
        return r.id === referenceRecord.id;
      }) == null) {
      ...
      return {
        finalData: __spreadArray22([referenceRecord], possibleValuesData !== null && possibleValuesData !== void 0 ? possibleValuesData : [], true),
  ...
  var refetch2 = (0, import_react109.useCallback)(function() {
    refetchGetList();
    refetchReference();
  }, [refetchGetList, refetchReference]);
  var currentSort = (0, import_react109.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var ChoicesContext = (0, import_react110.createContext)(void 0);

// node_modules/ra-core/dist/esm/form/choices/ChoicesContextProvider.js
var ChoicesContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React43.createElement(ChoicesContext.Provider, { value }, children);
};
...
var ReferenceInputBase = function(props) {
  var children = props.children, _a12 = props.filter, filter = _a12 === void 0 ? {} : _a12, offline = props.offline, reference = props.reference, _b = props.sort, sort = _b === void 0 ? { field: "id", order: "DESC" } : _b;
  var controllerProps = useReferenceInputController(__assign50(__assign50({}, props), { sort, filter }));
  var isPaused = controllerProps.isPaused, isPending = controllerProps.isPending;
  var shouldRenderOffline = isPaused && isPending && offline !== void 0 && offline !== false;
  return import_react111.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react111.default.createElement(ChoicesContextProvider, { value: controllerProps }, shouldRenderOffline ? offline : children)
  );
};

// node_modules/ra-core/dist/esm/controller/input/ReferenceArrayInputBase.js
var React46 = __toESM(require_react());

// node_modules/ra-core/dist/esm/core/ResourceContextProvider.js
var React45 = __toESM(require_react());
var ResourceContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return value ? React45.createElement(ResourceContext.Provider, { value }, children) : children;
};
...
var ReferenceArrayInputBase = function(props) {
  var children = props.children, _a12 = props.filter, filter = _a12 === void 0 ? defaultFilter6 : _a12, offline = props.offline, reference = props.reference, render = props.render, sort = props.sort;
  if (children && React46.Children.count(children) !== 1) {
  ...
  var controllerProps = useReferenceArrayInputController(__assign51(__assign51({}, props), { sort, filter }));
  var isPaused = controllerProps.isPaused, isPending = controllerProps.isPending;
  var shouldRenderOffline = isPaused && isPending && offline !== void 0 && offline !== false;
  return React46.createElement(
    ResourceContextProvider,
    { value: reference },
    React46.createElement(ChoicesContextProvider, { value: controllerProps }, shouldRenderOffline ? offline : render ? render(controllerProps) : children)
  );
};
var defaultFilter6 = {};

// node_modules/ra-core/dist/esm/controller/input/ArrayInputContext.js
var import_react112 = __toESM(require_react());
var ArrayInputContext = (0, import_react112.createContext)(void 0);

// node_modules/ra-core/dist/esm/controller/input/useArrayInput.js
var import_react113 = __toESM(require_react());
var useArrayInput = function(props) {
  var context = (0, import_react113.useContext)(ArrayInputContext);
  var memo2 = (0, import_react113.useMemo)(function() {
    return {
...
// node_modules/ra-core/dist/esm/controller/input/sanitizeInputRestProps.js
...
var sanitizeInputRestProps = function(_a12) {
  var afterSubmit = _a12.afterSubmit, allowNull = _a12.allowNull, alwaysOn = _a12.alwaysOn, beforeSubmit = _a12.beforeSubmit, component = _a12.component, data = _a12.data, defaultValue = _a12.defaultValue, error = _a12.error, format2 = _a12.format, formatOnBlur = _a12.formatOnBlur, initializeForm = _a12.initializeForm, input = _a12.input, isEqual10 = _a12.isEqual, isRequired2 = _a12.isRequired, label = _a12.label, limitChoicesToValue = _a12.limitChoicesToValue, locale = _a12.locale, meta = _a12.meta, multiple = _a12.multiple, name = _a12.name, options = _a12.options, optionText = _a12.optionText, optionValue = _a12.optionValue, parse4 = _a12.parse, record = _a12.record, ref = _a12.ref, refetch2 = _a12.refetch, render = _a12.render, resource = _a12.resource, setFilter = _a12.setFilter, setPagination = _a12.setPagination, setSort = _a12.setSort, shouldUnregister = _a12.shouldUnregister, source = _a12.source, submitError = _a12.submitError, subscription = _a12.subscription, textAlign = _a12.textAlign, translate = _a12.translate, translateChoice = _a12.translateChoice, validate = _a12.validate, validateFields = _a12.validateFields, value = _a12.value, rest = __rest45(_a12, ["afterSubmit", "allowNull", "alwaysOn", "beforeSubmit", "component", "data", "defaultValue", "error", "format", "formatOnBlur", "initializeForm", "input", "isEqual", "isRequired", "label", "limitChoicesToValue", "locale", "meta", "multiple", "name", "options", "optionText", "optionValue", "parse", "record", "ref", "refetch", "render", "resource", "setFilter", "setPagination", "setSort", "shouldUnregister", "source", "submitError", "subscription", "textAlign", "translate", "translateChoice", "validate", "validateFields", "value"]);
  return rest;
};

// node_modules/ra-core/dist/esm/controller/input/SimpleFormIteratorContext.js
var import_react114 = __toESM(require_react());
var SimpleFormIteratorContext = (0, import_react114.createContext)(void 0);

// node_modules/ra-core/dist/esm/controller/input/SimpleFormIteratorItemContext.js
var import_react115 = __toESM(require_react());
var SimpleFormIteratorItemContext = (0, import_react115.createContext)(void 0);

// node_modules/ra-core/dist/esm/controller/input/useSimpleFormIterator.js
var import_react116 = __toESM(require_react());
var useSimpleFormIterator = function() {
  var context = (0, import_react116.useContext)(SimpleFormIteratorContext);
  if (!context) {
...
// node_modules/ra-core/dist/esm/controller/input/useSimpleFormIteratorItem.js
var import_react117 = __toESM(require_react());
var useSimpleFormIteratorItem = function() {
  var context = (0, import_react117.useContext)(SimpleFormIteratorItemContext);
  if (!context) {
...
var useShowController = function(props) {
  ...
  var _a12 = props.disableAuthentication, disableAuthentication = _a12 === void 0 ? false : _a12, propsId = props.id, _b = props.queryOptions, queryOptions2 = _b === void 0 ? {} : _b, _c = props.redirectOnError, redirectOnError = _c === void 0 ? DefaultRedirectOnError2 : _c;
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var meta = queryOptions2.meta, otherQueryOptions = __rest46(queryOptions2, ["meta"]);
  var _d = useGetOne(resource, { id, meta }, __assign52({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, onError: function() {
    notify("ra.notification.item_doesnt_exist", {
      type: "error"
    });
    redirect(redirectOnError, resource, id);
  }, retry: false }, otherQueryOptions)), record = _d.data, error = _d.error, isLoading = _d.isLoading, isFetching = _d.isFetching, isPaused = _d.isPaused, isPending = _d.isPending, isPlaceholderData = _d.isPlaceholderData, refetch2 = _d.refetch;
  if (record && record.id && record.id != id) {
...
var ShowContext = (0, import_react118.createContext)(null);
ShowContext.displayName = "ShowContext";

// node_modules/ra-core/dist/esm/controller/show/ShowContextProvider.js
var ShowContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React47.createElement(
    ShowContext.Provider,
    { value },
    React47.createElement(RecordContextProvider, { value: value && value.record }, children)
  );
};
...
var ShowBase = function(_a12) {
  var authLoading = _a12.authLoading, loading = _a12.loading, offline = _a12.offline, error = _a12.error, redirectOnError = _a12.redirectOnError, children = _a12.children, render = _a12.render, props = __rest47(_a12, ["authLoading", "loading", "offline", "error", "redirectOnError", "children", "render"]);
  var hasError = error !== false && error !== void 0;
  var controllerProps = useShowController(__assign53(__assign53({}, props), { redirectOnError: redirectOnError !== null && redirectOnError !== void 0 ? redirectOnError : hasError ? false : void 0 }));
  var isAuthPending = useIsAuthPending({
    resource: controllerProps.resource,
    action: "show"
  });
  ...
  return (
    ...
    React48.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React48.createElement(ShowContextProvider, { value: controllerProps }, showAuthLoading ? authLoading : showLoading ? loading : showOffline ? offline : showError ? error : render ? render(controllerProps) : children)
    )
  );
};
...
var ShowController = function(_a12) {
  var children = _a12.children, props = __rest48(_a12, ["children"]);
...
var useShowContext = function() {
  var context = (0, import_react119.useContext)(ShowContext);
  if (!context) {
...
var usePrevNextController = function(props) {
  ...
  var filter = __assign54(__assign54({}, storedParams.filter), permanentFilter);
  var meta = queryOptions2.meta, otherQueryOptions = __rest49(queryOptions2, ["meta"]);
  var params = { pagination, sort, filter, meta };
  var queryData = queryClient.getQueryData([
    resource,
    "getList",
    __assign54(__assign54({}, params), { pagination: {
      page: storedParams.page,
      perPage: storedParams.perPage
    } })
  ]);
  var recordIndexInQueryData = (_a12 = queryData === null || queryData === void 0 ? void 0 : queryData.data) === null || _a12 === void 0 ? void 0 : _a12.findIndex(function(r) {
  ...
  var _l = useQuery(__assign54({ queryKey: [resource, "getList", params], queryFn: function(queryParams) {
    return dataProvider.getList(resource, __assign54(__assign54({}, params), { signal: dataProvider.supportAbortSignal === true ? queryParams.signal : void 0 }));
...
var useCanAccess = function(params) {
  ...
  var _record = params.record, restParams = __rest50(params, ["record"]);
  var authProviderHasCanAccess = !!(authProvider === null || authProvider === void 0 ? void 0 : authProvider.canAccess);
  var queryResult = useQuery(__assign55({ queryKey: [
    "auth",
    "canAccess",
    __assign55(__assign55({}, restParams), { recordId: record === null || record === void 0 ? void 0 : record.id, resource })
  ], queryFn: function(_a12) {
    return __awaiter11(void 0, [_a12], void 0, function(_b) {
      var signal = _b.signal;
      return __generator11(this, function(_c) {
        if (!authProvider || !authProvider.canAccess) {
          return [2, true];
        }
        return [2, authProvider.canAccess(__assign55(__assign55({}, params), { record, resource, signal: authProvider.supportAbortSignal ? signal : void 0 }))];
      });
    });
  }, enabled: authProviderHasCanAccess }, params));
  var result = (0, import_react120.useMemo)(function() {
    return __assign55(__assign55({}, queryResult), { canAccess: queryResult.data });
  }, [queryResult]);
...
var CanAccess = function(_a12) {
  var children = _a12.children, _b = _a12.loading, loading = _b === void 0 ? null : _b, _c = _a12.accessDenied, accessDenied = _c === void 0 ? null : _c, _d = _a12.error, errorElement = _d === void 0 ? DEFAULT_ERROR : _d, props = __rest51(_a12, ["children", "loading", "accessDenied", "error"]);
...
var CanAccessDefaultError = function() {
  var basename = useBasename();
  return React49.createElement(Navigate, { to: "".concat(basename, "/authentication-error") });
};
var DEFAULT_ERROR = React49.createElement(CanAccessDefaultError, null);
...
var useCanAccessResources = function(params) {
  var authProvider = useAuthProvider_default();
  var record = useRecordContext(params);
  var action = params.action, resources = params.resources, options = __rest52(params, ["action", "resources"]);
  var queryResult = useQuery(__assign56({ queryKey: ["auth", "canAccess", resources, action, record], queryFn: function(_a12) {
    return __awaiter12(void 0, [_a12], void 0, function(_b) {
      var queries, result2;
      var signal = _b.signal;
      return __generator12(this, function(_c) {
        switch (_c.label) {
          case 0:
            return [4, Promise.all(resources.map(function(resource) {
              return __awaiter12(void 0, void 0, void 0, function() {
                var canAccess;
                return __generator12(this, function(_a13) {
                  switch (_a13.label) {
                    case 0:
                      if (!authProvider || !authProvider.canAccess) {
          ...
          case 1:
            queries = _c.sent();
            result2 = queries.reduce(function(acc, _a13) {
              var resource = _a13.resource, canAccess = _a13.canAccess;
  ...
  var result = (0, import_react122.useMemo)(function() {
    return __assign56({ canAccess: queryResult.data }, queryResult);
  }, [queryResult]);
  var resultWithoutAuthProvider = (0, import_react122.useMemo)(function() {
    return {
...
var useCanAccessCallback = function(options) {
  ...
  var authProvider = useAuthProvider_default();
  var mutateAsync = useMutation(__assign57({ mutationFn: function(params) {
...
var useCheckAuth = function() {
  ...
  var basename = useBasename();
  var loginUrl = removeDoubleSlashes("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
  var checkAuth = (0, import_react123.useCallback)(function() {
    var args_1 = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args_1[_i] = arguments[_i];
    }
    return __awaiter14(void 0, __spreadArray23([], args_1, true), void 0, function(params, logoutOnFailure, redirectTo) {
      ...
      return __generator14(this, function(_a12) {
        switch (_a12.label) {
          case 0:
            if (!authProvider) {
              return [2, checkAuthWithoutAuthProvider()];
            }
            _a12.label = 1;
          case 1:
            _a12.trys.push([1, 3, , 4]);
            return [4, authProvider.checkAuth(params)];
          case 2:
            return [2, _a12.sent()];
          case 3:
            error_1 = _a12.sent();
            if (logoutOnFailure) {
              logout({}, error_1 && error_1.redirectTo != null ? error_1.redirectTo : redirectTo);
              shouldSkipNotify = error_1 && error_1.message === false;
              !shouldSkipNotify && notify(getErrorMessage3(error_1, "ra.auth.auth_check_error"), { type: "error" });
            }
            throw error_1;
          case 4:
            return [
...
var useGetIdentity = function(options) {
  ...
  var authProvider = useAuthProvider_default();
  var onSuccess = options.onSuccess, onError = options.onError, onSettled = options.onSettled, queryOptions2 = __rest53(options, ["onSuccess", "onError", "onSettled"]);
  var result = useQuery(__assign58({ queryKey: ["auth", "getIdentity"], queryFn: function(_a12) {
    return __awaiter15(void 0, [_a12], void 0, function(_b) {
      var signal = _b.signal;
  ...
  return (0, import_react124.useMemo)(function() {
    return __assign58(__assign58({}, result), { identity: result.data });
  }, [result]);
};
var noop11 = function() {
};
...
var useHandleAuthCallback = function(options) {
  ...
  var _a12 = options !== null && options !== void 0 ? options : {}, onSuccess = _a12.onSuccess, onError = _a12.onError, onSettled = _a12.onSettled, queryOptions2 = __rest54(_a12, ["onSuccess", "onError", "onSettled"]);
  var handleCallbackPromise;
  var queryResult = useQuery(__assign59({ queryKey: ["auth", "handleCallback"], queryFn: function(_a13) {
    var signal = _a13.signal;
  ...
  var onSuccessEvent = useEvent(onSuccess !== null && onSuccess !== void 0 ? onSuccess : (function(data) {
    ...
    var redirectTo = (_a13 = data === null || data === void 0 ? void 0 : data.redirectTo) !== null && _a13 !== void 0 ? _a13 : previousLocation;
    if (redirectTo === false) {
      return;
    }
...
var useIsAuthPending = function(params) {
  var action = params.action, props = __rest55(params, ["action"]);
  var queryClient = useQueryClient();
  var authProvider = useAuthProvider_default();
  var resource = useResourceContext(props);
  if (!authProvider) {
...
var useRequireAccess = function(params) {
  var _a12 = useCanAccess(params), canAccess = _a12.canAccess, data = _a12.data, error = _a12.error, rest = __rest56(_a12, ["canAccess", "data", "error"]);
  var navigate = useNavigate();
  var basename = useBasename();
    ...
    get: function(_, name) {
      ...
      return function() {
        ...
        return __awaiter17(_this, void 0, void 0, function() {
          return __generator17(this, function(_a12) {
            switch (_a12.label) {
              case 0:
                return [4, refreshAuth()];
              case 1:
...
var useGetPathForRecord = function(options) {
  ...
  var createPath = useCreatePath();
  var _a12 = (0, import_react127.useState)(link && typeof link !== "function" && record != null ? createPath({
    resource,
    id: record.id,
    type: link
  }) : false), path = _a12[0], setPath = _a12[1];
...
var ResourceDefinitionContext = (0, import_react128.createContext)({
  definitions: {},
  register: function() {
  },
  unregister: function() {
...
var ResourceDefinitionContextProvider = function(_a12) {
  var _b = _a12.definitions, defaultDefinitions = _b === void 0 ? {} : _b, children = _a12.children;
  var _c = (0, import_react128.useState)(defaultDefinitions), definitions = _c[0], setState = _c[1];
  var register = (0, import_react128.useCallback)(function(config) {
    setState(function(prev) {
      var _a13;
      return (0, import_isEqual5.default)(prev[config.name], config) ? prev : __assign60(__assign60({}, prev), (_a13 = {}, _a13[config.name] = config, _a13));
    });
  }, []);
  var unregister = (0, import_react128.useCallback)(function(config) {
    setState(function(prev) {
      var _a13 = prev, _b2 = config.name, _ = _a13[_b2], rest = __rest57(_a13, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
  var contextValue = (0, import_react128.useMemo)(
    function() {
  ...
  return React50.createElement(ResourceDefinitionContext.Provider, { value: contextValue }, children);
};

// node_modules/ra-core/dist/esm/core/useResourceDefinitionContext.js
var useResourceDefinitionContext = function() {
  return (0, import_react129.useContext)(ResourceDefinitionContext);
};
...
var useGetPathForRecordCallback = function(options) {
  ...
  return (0, import_react130.useCallback)(function(params) {
    return __awaiter18(void 0, void 0, void 0, function() {
      var _a12, link, record, finalResource, resourceDefinition, _b, canAccessShow, canAccessEdit, linkFunc, linkResult, linkResultIsPromise, resolvedLink;
      var _c, _d;
      return __generator18(this, function(_e) {
        switch (_e.label) {
          case 0:
            _a12 = params || {}, link = _a12.link, record = _a12.record;
...
var useResetErrorBoundaryOnLocationChange = function(resetErrorBoundary) {
  ...
  var originalPathname = (0, import_react131.useRef)(pathname);
...
var useScrollToTop = function() {
  ...
  (0, import_react132.useEffect)(function() {
    var _a12;
    if (((_a12 = location.state) === null || _a12 === void 0 ? void 0 : _a12._scrollToTop) && typeof window != "undefined" && typeof window.scrollTo === "function") {
      window.scrollTo(0, 0);
    }
  }, [location]);
};
...
var UseLocation = function(_a12) {
  var locationCallback = _a12.locationCallback;
  var location = useLocation();
  locationCallback(location);
  return null;
};
var UseNavigate = function(_a12) {
  var navigateCallback = _a12.navigateCallback;
  var navigate = useNavigate();
  navigateCallback(navigate);
  return null;
};
var TestMemoryRouter = function(_a12) {
  var children = _a12.children, locationCallback = _a12.locationCallback, navigateCallback = _a12.navigateCallback, rest = __rest58(_a12, ["children", "locationCallback", "navigateCallback"]);
  var router = createMemoryRouter([
    {
      path: "*",
      element: React51.createElement(
        React51.Fragment,
        null,
        children,
        locationCallback && React51.createElement(UseLocation, { locationCallback }),
        navigateCallback && React51.createElement(UseNavigate, { navigateCallback })
      )
    }
  ], __assign61({ future: {
    v7_fetcherPersist: false,
  ...
  return React51.createElement(RouterProvider2, {
    router,
...
var PreferencesEditorContext = (0, import_react133.createContext)(void 0);

// node_modules/ra-core/dist/esm/preferences/PreferencesEditorContextProvider.js
var PreferencesEditorContextProvider = function(_a12) {
  var children = _a12.children;
  var _b = (0, import_react134.useState)(false), isEnabled = _b[0], setIsEnabled = _b[1];
  var _c = (0, import_react134.useState)(null), editor = _c[0], setEditor = _c[1];
  var _d = (0, import_react134.useState)(null), preferenceKey = _d[0], setPreferenceKey = _d[1];
  var _e = (0, import_react134.useState)(null), path = _e[0], setPath = _e[1];
  var _f = (0, import_react134.useState)(null), title = _f[0], setTitleString = _f[1];
  var _g = (0, import_react134.useState)(), titleOptions = _g[0], setTitleOptions = _g[1];
  var enable = (0, import_react134.useCallback)(function() {
    return setIsEnabled(true);
  }, []);
  var disable = (0, import_react134.useCallback)(function() {
    setIsEnabled(false);
    setEditor(null);
  }, []);
  var setTitle = (0, import_react134.useCallback)(function(title2, titleOptions2) {
    setTitleString(title2);
    setTitleOptions(titleOptions2);
  }, []);
  var context = (0, import_react134.useMemo)(function() {
    return {
      editor,
      setEditor,
      preferenceKey,
  ...
  return React52.createElement(PreferencesEditorContext.Provider, { value: context }, children);
};

// node_modules/ra-core/dist/esm/core/CoreAdminContext.js
var defaultStore2 = memoryStore();
var CoreAdminContext = function(props) {
  var authProvider = props.authProvider, basename = props.basename, _a12 = props.dataProvider, dataProvider = _a12 === void 0 ? defaultDataProvider : _a12, i18nProvider = props.i18nProvider, _b = props.store, store = _b === void 0 ? defaultStore2 : _b, children = props.children, queryClient = props.queryClient;
  if (!dataProvider) {
    throw new Error("Missing dataProvider prop.\nReact-admin requires a valid dataProvider function to work.");
  }
  var finalQueryClient = (0, import_react135.useMemo)(function() {
    return queryClient || new QueryClient();
  }, [queryClient]);
  var finalAuthProvider = (0, import_react135.useMemo)(function() {
    return authProvider instanceof Function ? convertLegacyAuthProvider_default(authProvider) : authProvider;
  }, [authProvider]);
  var finalDataProvider = (0, import_react135.useMemo)(function() {
              ...
              React53.createElement(
                ...
                React53.createElement(
                  ...
                  React53.createElement(
                    ...
                    null,
                    React53.createElement(ResourceDefinitionContextProvider, null, children)
                  )
                )
              )
            )
...
var ErrorBoundaryContext = (0, import_react136.createContext)(null);
var initialState = {
  didCatch: false,
  error: null
};
var ErrorBoundary = class extends import_react136.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (didCatch) {
      ...
      if (typeof fallbackRender === "function") {
        ...
        childToRender = (0, import_react136.createElement)(FallbackComponent, props);
    ...
    return (0, import_react136.createElement)(ErrorBoundaryContext.Provider, {
      value: {
        didCatch,
        error,
        resetErrorBoundary: this.resetErrorBoundary
...
var useConfigureAdminRouterFromChildren = function(children) {
  var _a12 = usePermissions_default(), permissions = _a12.permissions, isPending = _a12.isPending;
...
var useRoutesAndResourcesFromChildren = function(children, permissions, isLoading) {
  ...
  var _a12 = useRoutesAndResourcesState(getRoutesAndResourceFromNodes(children)), routesAndResources = _a12[0], setRoutesAndResources = _a12[1], mergeRoutesAndResources = _a12[2];
  var _b = (0, import_react137.useState)(function() {
    return getStatus(__assign62({ children }, routesAndResources));
  ...
  (0, import_react137.useEffect)(function() {
    var resolveChildFunction = function(childFunc) {
      return __awaiter19(void 0, void 0, void 0, function() {
        ...
        return __generator19(this, function(_a13) {
          try {
...
var useRoutesAndResourcesState = function(initialState2) {
  var _a12 = (0, import_react137.useState)(initialState2), routesAndResources = _a12[0], setRoutesAndResources = _a12[1];
  var mergeRoutesAndResources = (0, import_react137.useCallback)(function(newRoutesAndResources) {
...
var useRegisterResources = function(resources, permissions) {
  var _a12 = useResourceDefinitionContext(), register = _a12.register, unregister = _a12.unregister;
  (0, import_react137.useEffect)(function() {
...
var getStatus = function(_a12) {
  var children = _a12.children, resources = _a12.resources, customRoutesWithLayout = _a12.customRoutesWithLayout, customRoutesWithoutLayout = _a12.customRoutesWithoutLayout;
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  import_react137.Children.forEach(children, function(element) {
    if (!React54.isValidElement(element)) {
      return;
    }
    if (element.type === import_react137.Fragment) {
...
var HasDashboardContext = (0, import_react138.createContext)(false);
var HasDashboardContextProvider = HasDashboardContext.Provider;
var useHasDashboard = function() {
  return (0, import_react138.useContext)(HasDashboardContext);
};
...
var useFirstResourceWithListAccess = function() {
  ...
  var _a12 = useCanAccessResources({
    action: "list",
    resources: resourcesNames,
    enabled: !isPendingAuthenticated
  }), canAccess = _a12.canAccess, isPending = _a12.isPending;
...
// node_modules/ra-core/dist/esm/core/NavigateToFirstResource.js
var NavigateToFirstResource = function(_a12) {
  var LoadingPage = _a12.loading;
  var _b = useFirstResourceWithListAccess(), resource = _b.resource, isPending = _b.isPending;
  var createPath = useCreatePath();
  if (isPending) {
    return React55.createElement(LoadingPage, null);
  }
  if (resource) {
    return React55.createElement(Navigate, { to: createPath({
      resource,
      type: "list"
    }), replace: true });
  }
...
var CoreAdminRoutes = function(props) {
  useScrollToTop();
  var _a12 = useConfigureAdminRouterFromChildren(props.children), customRoutesWithLayout = _a12.customRoutesWithLayout, customRoutesWithoutLayout = _a12.customRoutesWithoutLayout, status = _a12.status, resources = _a12.resources;
  ...
  if (status === "empty") {
    ...
    return React56.createElement(Ready, null);
  }
  if (status === "loading" || requireAuth && isPendingAuthenticated) {
    return React56.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      React56.createElement(Route, { path: "*", element: React56.createElement(
        "div",
        { style: { height: "100vh" } },
        React56.createElement(LoadingPage, null)
      ) })
    );
  }
  if (requireAuth && (isPendingAuthenticated || !authenticated)) {
    return React56.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      React56.createElement(Route, { path: "*", element: React56.createElement(LogoutOnMount, null) })
    );
  }
  return React56.createElement(
    Routes,
    ...
    React56.createElement(Route, { path: "/*", element: React56.createElement(
      ...
      React56.createElement(
        ...
        React56.createElement(
          ...
          null,
          customRoutesWithLayout,
          import_react139.Children.map(resources, function(resource) {
            return React56.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource });
          }),
          React56.createElement(Route, { path: "/", element: dashboard ? React56.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard, loading: LoadingPage }) : React56.createElement(NavigateToFirstResource, { loading: LoadingPage }) }),
          React56.createElement(Route, { path: "/authentication-error", element: React56.createElement(AuthenticationError, null) }),
          React56.createElement(Route, { path: "/access-denied", element: React56.createElement(AccessDenied, null) }),
          React56.createElement(Route, { path: "*", element: React56.createElement(CatchAll, null) })
        )
      )
    ) })
  );
...
var DefaultTitleContext = (0, import_react140.createContext)("React Admin");
var DefaultTitleContextProvider = DefaultTitleContext.Provider;
var useDefaultTitle = function() {
  return (0, import_react140.useContext)(DefaultTitleContext);
};

// node_modules/ra-core/dist/esm/core/CoreAdminUI.js
var DefaultLayout = function(_a12) {
  var children = _a12.children;
  return React57.createElement(React57.Fragment, null, children);
};
var DefaultError = function(_a12) {
  var error = _a12.error, errorInfo = _a12.errorInfo, resetErrorBoundary = _a12.resetErrorBoundary;
  useResetErrorBoundaryOnLocationChange(resetErrorBoundary);
  return React57.createElement(
    "div",
    null,
    React57.createElement("h1", null, "Error"),
...
var CoreAdminUI = function(props) {
  var _a12 = (0, import_react141.useState)({}), errorInfo = _a12[0], setErrorInfo = _a12[1];
  ...
  return React57.createElement(
    ...
    React57.createElement(
      ErrorBoundary,
      { onError: handleError, fallbackRender: function(_a13) {
        var error = _a13.error, resetErrorBoundary = _a13.resetErrorBoundary;
        return React57.createElement(
          "div",
          { style: { minHeight: "100vh" } },
          React57.createElement(ErrorComponent, { error, errorInfo, resetErrorBoundary })
        );
      } },
      React57.createElement(
        Routes,
        null,
        LoginPage !== false && LoginPage !== true ? React57.createElement(Route, { path: "/login", element: createOrGetElement(LoginPage) }) : null,
        LoginCallbackPage !== false && LoginCallbackPage !== true ? React57.createElement(Route, { path: "/auth-callback", element: createOrGetElement(LoginCallbackPage) }) : null,
        React57.createElement(Route, { path: "/*", element: React57.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, requireAuth, ready, authenticationError, accessDenied }, children) })
      )
    )
  );
};
var createOrGetElement = function(el) {
  return (0, import_react141.isValidElement)(el) ? el : (0, import_react141.createElement)(el);
};
var Noop2 = function() {
  return null;
};
...
// node_modules/ra-core/dist/esm/core/useIsOffline.js
var React59 = __toESM(require_react());
var useIsOffline = function() {
  var _a12 = React59.useState(onlineManager.isOnline()), isOnline = _a12[0], setIsOnline = _a12[1];
...
// node_modules/ra-core/dist/esm/core/IsOffline.js
var IsOffline = function(_a12) {
  var children = _a12.children;
...
var OptionalResourceContextProvider = function(_a12) {
  var value = _a12.value, children = _a12.children;
  return value ? React60.createElement(ResourceContextProvider, { value }, children) : children;
};
...
var Resource = function(props) {
  ...
  return React61.createElement(
    ...
    React61.createElement(
      Routes,
      null,
      create && React61.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React61.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React61.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React61.createElement(Route, { path: "/*", element: React61.createElement(RestoreScrollPosition, { storeKey: "".concat(name, ".list.scrollPosition") }, getElement(list)) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  if ((0, import_react142.isValidElement)(ElementOrComponent)) {
    return ElementOrComponent;
  }
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    var Element_1 = ElementOrComponent;
    return React61.createElement(Element_1, null);
  }
  return null;
};
Resource.raName = "Resource";
Resource.registerResource = function(_a12) {
  var create = _a12.create, edit = _a12.edit, icon = _a12.icon, list = _a12.list, name = _a12.name, options = _a12.options, show = _a12.show, recordRepresentation = _a12.recordRepresentation, hasCreate = _a12.hasCreate, hasEdit = _a12.hasEdit, hasShow = _a12.hasShow;
  return {
    name,
    options,
    hasList: !!list,
...
var SourceContext = (0, import_react143.createContext)(void 0);
...
var useSourceContext = function() {
  var context = (0, import_react143.useContext)(SourceContext);
  if (!context) {
...
var useOptionalSourceContext = function() {
  return (0, import_react143.useContext)(SourceContext);
};

// node_modules/ra-core/dist/esm/core/UserMenuContext.js
var import_react144 = __toESM(require_react());
var UserMenuContext = (0, import_react144.createContext)(void 0);

// node_modules/ra-core/dist/esm/core/UserMenuContextProvider.js
var React62 = __toESM(require_react());
var UserMenuContextProvider = function(_a12) {
  var children = _a12.children, value = _a12.value;
  return React62.createElement(UserMenuContext.Provider, { value }, children);
};
...
var useResourceDefinition = function(props) {
  var resource = useResourceContext(props);
  var resourceDefinitions = useResourceDefinitions();
  var _a12 = props || {}, hasCreate = _a12.hasCreate, hasEdit = _a12.hasEdit, hasList = _a12.hasList, hasShow = _a12.hasShow, recordRepresentation = _a12.recordRepresentation;
  var definition = (0, import_react145.useMemo)(function() {
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react146.useCallback)(function(record) {
    if (!record)
      return "";
    ...
    if (typeof recordRepresentation === "string") {
      return (0, import_get8.default)(record, recordRepresentation);
    }
    if (React63.isValidElement(recordRepresentation)) {
...
// node_modules/ra-core/dist/esm/core/useUserMenu.js
var import_react147 = __toESM(require_react());
var useUserMenu = function() {
  return (0, import_react147.useContext)(UserMenuContext);
};
...
var useTranslateLabel = function() {
  ...
  return (0, import_react148.useCallback)(function(_a12) {
    var source = _a12.source, label = _a12.label, resource = _a12.resource;
...
var FieldTitle = function(props) {
  ...
  return React64.createElement(
    ...
    isRequired2 && React64.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
FieldTitle.displayName = "FieldTitle";
var FieldTitle_default = (0, import_react149.memo)(FieldTitle);
...
var Button = function(_a12) {
  var img = _a12.img, label = _a12.label, href = _a12.href;
  var _b = (0, import_react150.useState)(false), hovered = _b[0], setHovered = _b[1];
  return React65.createElement(
    "div",
    null,
    React65.createElement(
      "a",
      { href, style: hovered ? __assign63(__assign63({}, styles.link), styles.linkHovered) : styles.link, onMouseEnter: function() {
        return setHovered(true);
      }, onMouseLeave: function() {
        return setHovered(false);
      } },
      React65.createElement("img", { src: img, alt: label, style: styles.image }),
      React65.createElement("br", null),
      label
    )
  );
};
var Ready_default = (function() {
  return false ? React65.createElement("span", null) : React65.createElement(
    "div",
    { style: styles.root },
    React65.createElement(
      "div",
      ...
      React65.createElement("h1", null, "Welcome to React-admin"),
      React65.createElement(
        "div",
        null,
...
function useWhyDidYouUpdate(name, props) {
  var previousProps = (0, import_react151.useRef)();
  (0, import_react151.useEffect)(function() {
    if (previousProps.current) {
      var allKeys = Object.keys(__assign64(__assign64({}, previousProps.current), props));
      var changesObj_1 = {};
...
var getFieldLabelTranslationArgs = function(options) {
  ...
  if (typeof source === "undefined")
    return [""];
  var _a12 = getSourceParts(source), sourceWithoutDigits = _a12.sourceWithoutDigits, sourceSuffix = _a12.sourceSuffix;
...
var useLayoutEffect2 = typeof window !== "undefined" ? React66.useLayoutEffect : React66.useEffect;
var useEvent = function(fn) {
  var ref = React66.useRef(function() {
    throw new Error("Cannot call an event handler while rendering.");
  });
  useLayoutEffect2(function() {
    ref.current = fn;
  });
  return (0, import_react152.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var useLayoutEffect4 = typeof window !== "undefined" ? React67.useLayoutEffect : React67.useEffect;
var useDebouncedEvent = function(callback, delay) {
  var debouncedCallbackRef = (0, import_react153.useRef)(function() {
    throw new Error("Cannot call an event handler while rendering.");
  });
  ...
  return (0, import_react153.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var useFieldValue = function(params) {
  ...
  var record = useRecordContext(params);
  return (0, import_get9.default)(record, source, defaultValue);
};
...
var useCheckForApplicationUpdate = function(options) {
  var _a12 = options.url, url = _a12 === void 0 ? window.location.href : _a12, fetchOptions = options.fetchOptions, _b = options.interval, delay = _b === void 0 ? ONE_HOUR : _b, onNewVersionAvailableProp = options.onNewVersionAvailable, _c = options.disabled, disabled = _c === void 0 ? true : _c;
  var currentHash = (0, import_react154.useRef)();
...
var getHashForUrl = function(url, fetchOptions) {
  return __awaiter20(void 0, void 0, void 0, function() {
    ...
    return __generator20(this, function(_a12) {
      switch (_a12.label) {
        case 0:
          _a12.trys.push([0, 3, , 4]);
...
function useStore(key, defaultValue) {
  var _a12 = useStoreContext(), getItem = _a12.getItem, setItem = _a12.setItem, subscribe = _a12.subscribe;
  var _b = (0, import_react155.useState)(function() {
...
// node_modules/ra-core/dist/esm/i18n/I18nContextProvider.js
var I18nContextProvider = function(_a12) {
  var _b = _a12.value, value = _b === void 0 ? defaulti18nContext : _b, children = _a12.children;
  var locale = useStore("locale")[0];
  var notify = useNotify();
  var _c = (0, import_react156.useState)(0), key = _c[0], setKey = _c[1];
  var _d = (0, import_react156.useState)(locale === value.getLocale()), isInitialized = _d[0], setInitialized = _d[1];
  ...
  return isInitialized ? React68.createElement(I18nContext.Provider, { value, key }, children) : null;
};
...
var PreferenceKeyContext = (0, import_react157.createContext)("");
var PreferenceKeyContextProvider = function(_a12) {
  var _b = _a12.value, value = _b === void 0 ? "" : _b, children = _a12.children;
  return React69.createElement(PreferenceKeyContext.Provider, { value }, children);
};
var usePreferenceKey = function() {
  return (0, import_react157.useContext)(PreferenceKeyContext);
};
...
var usePreferencesEditor = function() {
  var context = (0, import_react158.useContext)(PreferencesEditorContext);
  if (!context) {
...
var usePreferenceInput = function(key, defaultValue) {
  var _a12 = usePreference(key, defaultValue), valueFromStore = _a12[0], setValueFromStore = _a12[1];
  var _b = (0, import_react159.useState)(valueFromStore), value = _b[0], setValue = _b[1];
  ...
  var onKeyDown = function(event) {
    ...
    if (event.key === "Enter") {
      ...
      if (form) {
        var index = __spreadArray24([], form, true).indexOf(event.target);
        (_a13 = form.elements[index + 1]) === null || _a13 === void 0 ? void 0 : _a13.focus();
      }
...
// node_modules/ra-core/dist/esm/dataTable/DataTableCallbacksContext.js
var import_react161 = __toESM(require_react());
var DataTableCallbacksContext = (0, import_react161.createContext)({});
var useDataTableCallbacksContext = function() {
  return (0, import_react161.useContext)(DataTableCallbacksContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableConfigContext.js
var import_react162 = __toESM(require_react());
var DataTableConfigContext = (0, import_react162.createContext)({
  expandSingle: false,
  hover: true,
  hasBulkActions: false
});
var useDataTableConfigContext = function() {
  return (0, import_react162.useContext)(DataTableConfigContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableDataContext.js
var import_react163 = __toESM(require_react());
var DataTableDataContext = (0, import_react163.createContext)(void 0);
var useDataTableDataContext = function() {
  return (0, import_react163.useContext)(DataTableDataContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableSelectedIdsContext.js
var import_react164 = __toESM(require_react());
var DataTableSelectedIdsContext = (0, import_react164.createContext)(void 0);
var useDataTableSelectedIdsContext = function() {
  return (0, import_react164.useContext)(DataTableSelectedIdsContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableSortContext.js
var import_react165 = __toESM(require_react());
var DataTableSortContext = (0, import_react165.createContext)(void 0);
var useDataTableSortContext = function() {
  return (0, import_react165.useContext)(DataTableSortContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableStoreContext.js
var import_react166 = __toESM(require_react());
var DataTableStoreContext = (0, import_react166.createContext)({
  storeKey: "",
  defaultHiddenColumns: []
});
var useDataTableStoreContext = function() {
  return (0, import_react166.useContext)(DataTableStoreContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableBase.js
var import_difference = __toESM(require_difference());
var import_union2 = __toESM(require_union());
...
var DataTableBase = function DataTable(props) {
  ...
  var children = props.children, empty = props.empty, expand = props.expand, _a12 = props.hiddenColumns, hiddenColumns = _a12 === void 0 ? emptyArray2 : _a12, hasBulkActions = props.hasBulkActions, hover = props.hover, loading = props.loading, isRowSelectable = props.isRowSelectable, isRowExpandable = props.isRowExpandable, resource = props.resource, rowClick = props.rowClick, _b = props.expandSingle, expandSingle = _b === void 0 ? false : _b;
  ...
  var handleSort = useEvent(function(event) {
    ...
    var newOrder = (sort === null || sort === void 0 ? void 0 : sort.field) === newField ? (sort === null || sort === void 0 ? void 0 : sort.order) === "ASC" ? "DESC" : "ASC" : event.currentTarget.dataset.order || "ASC";
    setSort({ field: newField, order: newOrder });
  });
  var lastSelected = (0, import_react167.useRef)(null);
  ...
  var handleToggleItem = useEvent(function(id, event) {
    ...
    if (event.shiftKey && lastSelectedIndex !== -1) {
      ...
      var newSelectedIds = isClickedItemSelected ? (0, import_difference.default)(selectedIds, idsBetweenSelections) : (0, import_union2.default)(selectedIds, idsBetweenSelections);
  ...
  var storeContextValue = (0, import_react167.useMemo)(function() {
    return {
      storeKey,
      defaultHiddenColumns: hiddenColumns
    };
  }, [storeKey, hiddenColumns]);
  var configContextValue = (0, import_react167.useMemo)(function() {
    return {
      expand,
      expandSingle,
      hasBulkActions,
  ...
  var callbacksContextValue = (0, import_react167.useMemo)(function() {
    return {
        ...
        React70.createElement(
          ...
          React70.createElement(
            ...
            React70.createElement(
              OptionalResourceContextProvider,
              { value: resource },
              React70.createElement(DataTableDataContext.Provider, { value: data }, children)
            )
          )
        )
      )
...
// node_modules/ra-core/dist/esm/dataTable/DataTableColumnRankContext.js
var import_react168 = __toESM(require_react());
var DataTableColumnRankContext = (0, import_react168.createContext)(void 0);
var useDataTableColumnRankContext = function() {
  return (0, import_react168.useContext)(DataTableColumnRankContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableColumnFilterContext.js
var import_react169 = __toESM(require_react());
var DataTableColumnFilterContext = (0, import_react169.createContext)(void 0);
var useDataTableColumnFilterContext = function() {
  return (0, import_react169.useContext)(DataTableColumnFilterContext);
};

// node_modules/ra-core/dist/esm/dataTable/DataTableRenderContext.js
var import_react170 = __toESM(require_react());
var DataTableRenderContext = (0, import_react170.createContext)("data");
var useDataTableRenderContext = function() {
  return (0, import_react170.useContext)(DataTableRenderContext);
};
...
var useChoicesContext = function(options) {
  ...
  var _d = useList({
    ...
    perPage: Infinity
  }), data = _d.data, list = __rest59(_d, ["data"]);
  var result = (0, import_react171.useMemo)(function() {
    var _a13, _b2, _c2, _d2, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z;
    if (options.choices || !context) {
      return {
        allChoices: data,
        availableChoices: (_a13 = options.availableChoices) !== null && _a13 !== void 0 ? _a13 : data,
        ...
        isFetching: (_j = list.isFetching) !== null && _j !== void 0 ? _j : false,
        // we must take the one for useList, otherwise the loading state isn't synchronized with the data
        isLoading: (_k = list.isLoading) !== null && _k !== void 0 ? _k : false,
        // same
        isPaused: (_l = list.isPaused) !== null && _l !== void 0 ? _l : false,
        // same
        isPending: (_m = list.isPending) !== null && _m !== void 0 ? _m : false,
        // same
        isPlaceholderData: (_o = list.isPlaceholderData) !== null && _o !== void 0 ? _o : false,
        // same
...
var useChoices = function(_a12) {
  var _b = _a12.optionText, optionText = _b === void 0 ? "name" : _b, _c = _a12.optionValue, optionValue = _c === void 0 ? "id" : _c, _d = _a12.disableValue, disableValue = _d === void 0 ? "disabled" : _d, _e = _a12.translateChoice, translateChoice = _e === void 0 ? true : _e, _f = _a12.createValue, createValue2 = _f === void 0 ? "@@ra-create" : _f, _g = _a12.createHintValue, createHintValue = _g === void 0 ? "@@ra-create-hint" : _g;
  var translate = useTranslate();
  var getChoiceText = (0, import_react172.useCallback)(function(choice) {
    if ((choice === null || choice === void 0 ? void 0 : choice.id) === createValue2 || (choice === null || choice === void 0 ? void 0 : choice.id) === createHintValue) {
      return (0, import_get10.default)(choice, typeof optionText === "string" ? optionText : "name");
    }
    if ((0, import_react172.isValidElement)(optionText)) {
      return React71.createElement(RecordContextProvider, { value: choice }, optionText);
    }
    var choiceName = typeof optionText === "function" ? optionText(choice) : (0, import_get10.default)(choice, optionText);
    return (0, import_react172.isValidElement)(choiceName) ? choiceName : translateChoice ? translate(String(choiceName), { _: choiceName }) : String(choiceName);
  }, [createHintValue, createValue2, optionText, translate, translateChoice]);
  var getChoiceValue = (0, import_react172.useCallback)(function(choice) {
    return (0, import_get10.default)(choice, optionValue, (0, import_get10.default)(choice, "id"));
  }, [optionValue]);
  var getDisableValue = (0, import_react172.useCallback)(function(choice) {
...
var FormGroupsContext = (0, import_react173.createContext)(void 0);

// node_modules/ra-core/dist/esm/form/groups/FormGroupsProvider.js
var __spreadArray25 = function(to, from, pack) {
  if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
    if (ar || !(i in from)) {
      if (!ar) ar = Array.prototype.slice.call(from, 0, i);
      ar[i] = from[i];
...
var FormGroupsProvider = function(_a12) {
  var children = _a12.children;
  var formGroups = (0, import_react174.useRef)({});
  var subscribers = (0, import_react174.useRef)({});
  var formContextValue = (0, import_react174.useMemo)(function() {
    return {
      /**
      ...
      registerField: function(source, group) {
        if (group != null) {
          if (!(formGroups.current[group] || []).includes(source)) {
            formGroups.current[group] = __spreadArray25(__spreadArray25([], formGroups.current[group] || [], true), [
              source
            ], false);
            if (subscribers.current[group]) {
  ...
  return React72.createElement(FormGroupsContext.Provider, { value: formContextValue }, children);
};
...
var useWarnWhenUnsavedChanges = function(enable, formRootPathname, control) {
  var translate = useTranslate();
  var _a12 = useFormState(control ? { control } : void 0), isSubmitSuccessful = _a12.isSubmitSuccessful, dirtyFields = _a12.dirtyFields;
  var isDirty = Object.keys(dirtyFields).length > 0;
  var _b = (0, import_react175.useState)(false), shouldNotify = _b[0], setShouldNotify = _b[1];
  var shouldNotBlock = !enable || !isDirty || isSubmitSuccessful;
  var blocker = useBlocker(function(_a13) {
    var currentLocation = _a13.currentLocation, nextLocation = _a13.nextLocation;
    if (shouldNotBlock)
      return false;
...
var WarnWhenUnsavedChanges = function(_a12) {
  var _b = _a12.enable, enable = _b === void 0 ? true : _b, formRootPathName = _a12.formRootPathName, formControl = _a12.formControl;
...
var getSimpleValidationResolver = function(validate) {
  return function(data) {
    return __awaiter21(void 0, void 0, void 0, function() {
      var errors, transformedErrors;
      return __generator21(this, function(_a12) {
        switch (_a12.label) {
          case 0:
...
var transformErrorFields = function(error) {
  return Object.keys(error).reduce(function(acc, field) {
    ...
    if (Array.isArray(error[field])) {
      ...
      return __assign65(__assign65({}, acc), (_a12 = {}, _a12[field] = transformedArrayErrors, _a12));
    }
    if (isEmptyObject(error[field])) {
      return acc;
    }
    if (typeof error[field] === "object" && !isRaTranslationObj(error[field])) {
      return __assign65(__assign65({}, acc), (_b = {}, _b[field] = transformErrorFields(error[field]), _b));
    }
    return __assign65(__assign65({}, acc), (_c = {}, _c[field] = addTypeAndMessage(error[field]), _c));
  }, {});
};
...
var setSubmissionErrors = function(errors, setError) {
  var setErrorFromObject = function(errors2, rootPath) {
    Object.entries(errors2).forEach(function(_a12) {
      var name = _a12[0], error = _a12[1];
...
var useNotifyIsFormInvalid = function(control, enabled) {
  ...
  var _a12 = useFormState(control ? { control } : void 0), submitCount = _a12.submitCount, errors = _a12.errors;
  var submitCountRef = (0, import_react176.useRef)(submitCount);
  var notify = useNotify();
  (0, import_react176.useEffect)(function() {
    ...
    if (submitCount > submitCountRef.current && enabled) {
      ...
      if (Object.keys(errors).length > 0) {
        var serverError = typeof ((_b = (_a13 = errors.root) === null || _a13 === void 0 ? void 0 : _a13.serverError) === null || _b === void 0 ? void 0 : _b.message) === "string" ? errors.root.serverError.message : void 0;
...
var useRecordFromLocation = function(props) {
  ...
  var location = useLocation();
  var _a12 = (0, import_react177.useState)(function() {
    return getRecordFromLocation(location, {
      stateSource,
      searchSource
    });
  }), recordFromLocation = _a12[0], setRecordFromLocation = _a12[1];
  var previousRecordRef = (0, import_react177.useRef)(recordFromLocation);
...
var getRecordFromLocation = function(_a12, _b) {
  var state = _a12.state, search = _a12.search;
...
var useAugmentedForm = function(props) {
  var _a12 = props.criteriaMode, criteriaMode = _a12 === void 0 ? "firstError" : _a12, defaultValues = props.defaultValues, formRootPathname = props.formRootPathname, resolver = props.resolver, _b = props.reValidateMode, reValidateMode = _b === void 0 ? "onChange" : _b, onSubmit = props.onSubmit, sanitizeEmptyValues2 = props.sanitizeEmptyValues, validate = props.validate, disableInvalidFormNotification = props.disableInvalidFormNotification, rest = __rest60(props, ["criteriaMode", "defaultValues", "formRootPathname", "resolver", "reValidateMode", "onSubmit", "sanitizeEmptyValues", "validate", "disableInvalidFormNotification"]);
  var saveContext = useSaveContext();
  var record = useRecordContext(props);
  var defaultValuesIncludingRecord = (0, import_react178.useMemo)(
    function() {
  ...
  var form = useForm(__assign66({ criteriaMode, values: defaultValuesIncludingRecord, reValidateMode, resolver: finalResolver }, rest));
  var formRef = (0, import_react178.useRef)(form);
  useNotifyIsFormInvalid(form.control, !disableInvalidFormNotification);
  var recordFromLocation = useRecordFromLocation();
  var recordFromLocationApplied = (0, import_react178.useRef)(false);
  ...
  var handleSubmit = (0, import_react178.useCallback)(function(values, event) {
    return __awaiter22(void 0, void 0, void 0, function() {
      var errors, finalValues;
      return __generator22(this, function(_a13) {
        switch (_a13.label) {
          case 0:
  ...
  var formHandleSubmit = (0, import_react178.useCallback)(function(event) {
...
function Form(props) {
  ...
  var dataRouterContext = (0, import_react179.useContext)(DataRouterContext);
  var dataRouterStateContext = (0, import_react179.useContext)(DataRouterStateContext);
    ...
    React73.createElement(
      ...
      React73.createElement(
        ...
        React73.createElement(
          FormGroupsProvider,
          null,
          React73.createElement("form", { onSubmit: formHandleSubmit, noValidate, id, className }, children),
          warnWhenUnsavedChanges && dataRouterContext && dataRouterStateContext && React73.createElement(WarnWhenUnsavedChangesComponent, { enable: true, formRootPathName: formRootPathname, formControl: form.control })
        )
      )
    )
  );
...
var useFormValues = function() {
  var getValues2 = useFormContext().getValues;
  return __assign68(__assign68({}, useWatch()), getValues2());
};
...
var FormDataConsumer = function(props) {
  ...
  return React74.createElement(FormDataConsumerView, __assign69({ formData }, props));
};
var FormDataConsumerView = function(props) {
  ...
  if (matches) {
    var scopedFormData = (0, import_get11.default)(formData, matches[0]);
...
var FormGroupContext = (0, import_react180.createContext)(null);
...
var useFormGroups = function() {
  var context = (0, import_react181.useContext)(FormGroupsContext);
  return context;
};
...
var FormGroupContextProvider = function(_a12) {
  var children = _a12.children, name = _a12.name;
  ...
  return React75.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useFormGroup = function(name) {
  var _a12 = useFormState(), dirtyFields = _a12.dirtyFields, touchedFields = _a12.touchedFields, validatingFields = _a12.validatingFields, errors = _a12.errors;
  ...
  var formGroups = useFormGroups();
  var _b = (0, import_react183.useState)({
    errors: void 0,
    isDirty: false,
    isTouched: false,
    isValid: true,
...
var useFormGroupContext = function() {
  var context = (0, import_react184.useContext)(FormGroupContext);
  return context;
};
...
var useApplyInputDefaultValues = function(_a12) {
  var inputProps = _a12.inputProps, isArrayInput = _a12.isArrayInput, fieldArrayInputControl = _a12.fieldArrayInputControl;
  ...
  var recordValue = (0, import_get13.default)(record, finalSource);
  var formValue = (0, import_get13.default)(getValues2(), finalSource);
  ...
  (0, import_react185.useEffect)(function() {
    ...
    if (pathContainsIndex) {
      ...
      var parentValue = (0, import_get13.default)(getValues2(), parentPath);
      if (parentValue == null) {
        return;
      }
    }
...
var useGetValidationErrorMessage = function() {
  ...
  return function(error) {
    if (error.message != null) {
      var _a12 = error, message2 = _a12.message, args = _a12.args;
      return translate(message2, __assign70({ _: message2 }, args));
    }
...
var oneOfTypeMessage = function(_a12) {
  var args = _a12.args;
  return {
...
var useUnique = function(options) {
  ...
  var translate = useTranslate();
  var record = useRecordContext();
  var debouncedGetList = (0, import_react186.useRef)(
    // The initial value is here to set the correct type on useRef
    asyncDebounce(dataProvider.getList, (_a12 = options === null || options === void 0 ? void 0 : options.debounce) !== null && _a12 !== void 0 ? _a12 : DEFAULT_DEBOUNCE)
  );
  var validateUnique = (0, import_react186.useCallback)(function(callTimeOptions) {
    var _a13 = (0, import_merge4.default)({
      debounce: DEFAULT_DEBOUNCE,
      filter: {},
      message: "ra.validation.unique"
    }, options, callTimeOptions), message2 = _a13.message, filter = _a13.filter, interval = _a13.debounce;
    ...
    return function(value, allValues, props) {
      return __awaiter23(void 0, void 0, void 0, function() {
        var finalFilter, _a14, data, total, error_1;
        return __generator23(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              _a14 = _b.sent(), data = _a14.data, total = _a14.total;
...
var ValidationError = function(props) {
  ...
  if (errorMessage.message) {
    var _a12 = errorMessage, message2 = _a12.message, args = _a12.args;
    return React76.createElement(React76.Fragment, null, translate(message2, __assign71({ _: message2 }, args)));
  }
  return React76.createElement(React76.Fragment, null, translate(errorMessage, { _: errorMessage }));
};
...
var useInput = function(props) {
  var defaultValue = props.defaultValue, _a12 = props.format, format2 = _a12 === void 0 ? defaultFormat : _a12, id = props.id, isRequiredOption = props.isRequired, name = props.name, initialOnBlur = props.onBlur, initialOnChange = props.onChange, _b = props.parse, parseProp = _b === void 0 ? defaultParse : _b, source = props.source, validate = props.validate, options = __rest61(props, ["defaultValue", "format", "id", "isRequired", "name", "onBlur", "onChange", "parse", "source", "validate"]);
  var finalSource = useWrappedSource(source);
  ...
  var defaultId = (0, import_react187.useId)();
  if (!finalName && true) {
  ...
  var _c = useController(__assign72({ name: finalName, defaultValue: (0, import_get14.default)(record, finalSource, defaultValue), rules: {
    validate: function(value, values) {
      return __awaiter24(void 0, void 0, void 0, function() {
        var error;
        return __generator24(this, function(_a13) {
          switch (_a13.label) {
            case 0:
              if (!sanitizedValidate)
                return [2, true];
              return [4, sanitizedValidate(value, values, __assign72(__assign72({}, props), { finalSource }))];
            case 1:
              error = _a13.sent();
              if (!error)
                return [2, true];
  ...
  var onChange = useEvent(function() {
    var _a13, _b2, _c2, _d, _e;
    var event = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      event[_i] = arguments[_i];
    }
    var eventOrValue = props.type === "checkbox" && ((_b2 = (_a13 = event[0]) === null || _a13 === void 0 ? void 0 : _a13.target) === null || _b2 === void 0 ? void 0 : _b2.value) === "on" ? event[0].target.checked : (_e = (_d = (_c2 = event[0]) === null || _c2 === void 0 ? void 0 : _c2.target) === null || _d === void 0 ? void 0 : _d.value) !== null && _e !== void 0 ? _e : event[0];
    controllerField.onChange(parse4 ? parse4(eventOrValue) : eventOrValue);
    if (initialOnChange) {
      initialOnChange.apply(void 0, event);
    }
  });
  var field = __assign72(__assign72({}, controllerField), { value: format2 ? format2(controllerField.value) : controllerField.value, onBlur, onChange });
  return {
    id: id || defaultId,
    field,
    fieldState,
...
var __spreadArray26 = function(to, from, pack) {
  if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
    if (ar || !(i in from)) {
      if (!ar) ar = Array.prototype.slice.call(from, 0, i);
      ar[i] = from[i];
...
var useSuggestions = function(_a12) {
  var allowCreate = _a12.allowCreate, choices2 = _a12.choices, _b = _a12.createText, createText = _b === void 0 ? "ra.action.create" : _b, _c = _a12.createValue, createValue2 = _c === void 0 ? "@@create" : _c, _d = _a12.createHintValue, createHintValue = _d === void 0 ? "@@ra-create-hint" : _d, limitChoicesToValue = _a12.limitChoicesToValue, matchSuggestion = _a12.matchSuggestion, optionText = _a12.optionText, optionValue = _a12.optionValue, selectedItem = _a12.selectedItem, _e = _a12.suggestionLimit, suggestionLimit = _e === void 0 ? 0 : _e, translateChoice = _a12.translateChoice;
  var translate = useTranslate();
  var _f = useChoices({
    optionText,
    optionValue,
  ...
  var getSuggestions = (0, import_react188.useCallback)(getSuggestionsFactory({
    allowCreate,
    choices: choices2,
    createText,
    createValue: createValue2,
...
var defaultMatchSuggestion = function(getChoiceText) {
  return function(filter, suggestion, exact) {
    ...
    var isReactElement = (0, import_react188.isValidElement)(suggestionText);
...
var getSuggestionsFactory = function(_a12) {
  var _b = _a12.allowCreate, allowCreate = _b === void 0 ? false : _b, _c = _a12.choices, choices2 = _c === void 0 ? [] : _c, _d = _a12.createText, createText = _d === void 0 ? "ra.action.create" : _d, _e = _a12.createValue, createValue2 = _e === void 0 ? "@@create" : _e, _f = _a12.optionText, optionText = _f === void 0 ? "name" : _f, _g = _a12.optionValue, optionValue = _g === void 0 ? "id" : _g, getChoiceText = _a12.getChoiceText, getChoiceValue = _a12.getChoiceValue, _h = _a12.limitChoicesToValue, limitChoicesToValue = _h === void 0 ? false : _h, _j = _a12.matchSuggestion, matchSuggestion = _j === void 0 ? defaultMatchSuggestion(getChoiceText) : _j, selectedItem = _a12.selectedItem, _k = _a12.suggestionLimit, suggestionLimit = _k === void 0 ? 0 : _k;
  return function(filter) {
    ...
    if (selectedItem && !Array.isArray(selectedItem) && matchSuggestion(filter, selectedItem)) {
      if (limitChoicesToValue) {
        ...
        suggestions = __spreadArray26([], choices2, true);
      }
    } else {
      suggestions = choices2.filter(function(choice) {
...
var getSuggestion = function(_a12) {
  var _b = _a12.optionText, optionText = _b === void 0 ? "name" : _b, _c = _a12.optionValue, optionValue = _c === void 0 ? "id" : _c, _d = _a12.text, text = _d === void 0 ? "" : _d, _e = _a12.value, value = _e === void 0 ? null : _e;
  var suggestion = {};
...
// node_modules/ra-core/dist/esm/form/useFormIsDirty.js
...
var FilterLiveForm = function(props) {
  var _a12 = useListContext(), filterValues = _a12.filterValues, setFilters = _a12.setFilters;
  var resource = useResourceContext(props);
  var _b = props.debounce, debounce5 = _b === void 0 ? 500 : _b, resolver = props.resolver, validate = props.validate, children = props.children, _c = props.formComponent, Component2 = _c === void 0 ? HTMLForm : _c, rest = __rest62(props, ["debounce", "resolver", "validate", "children", "formComponent"]);
  var finalResolver = resolver ? resolver : validate ? getSimpleValidationResolver(validate) : void 0;
  var formContext = useForm(__assign73({ mode: "onChange", resolver: finalResolver }, rest));
  ...
  var hasJustBeenModifiedByUser = React77.useRef(false);
  ...
  (0, import_react189.useEffect)(function() {
    var unsubscribe = watch(function(values, _a13) {
      var name = _a13.name;
      if (name) {
        if ((0, import_get15.default)(values, name) === "") {
  ...
  var sourceContext = React77.useMemo(function() {
    return {
      getSource: function(source) {
        return source;
      },
  ...
  return React77.createElement(
    ...
    React77.createElement(
      ...
      React77.createElement(
        SourceContextProvider,
        { value: sourceContext },
        React77.createElement(Component2, { onSubmit: handleSubmit(onSubmit) }, children)
      )
    )
  );
};
var HTMLForm = function(props) {
  return React77.createElement("form", __assign73({}, props));
};
...
var mergeObjNotArray = function(a, b) {
  return (0, import_mergeWith.default)((0, import_cloneDeep2.default)(a), b, mergeCustomizer);
};
...
var getInputValue = function(formValues, key, filterValues) {
  if (formValues[key] === void 0 || formValues[key] === null) {
    return (0, import_get15.default)(filterValues, key, "");
  }
...
var InferredElement = (
  ...
  (function() {
    ...
    InferredElement2.prototype.getElement = function(props) {
      ...
      return this.children ? (0, import_react190.createElement)(this.type.component, __assign74(__assign74({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
        return child.getElement({ key: index });
      }) : this.children.getElement()) : (0, import_react190.createElement)(this.type.component, __assign74(__assign74({}, this.props), props));
    };
...
function startOfWeek(date, options) {
  ...
  const weekStartsOn = (options == null ? void 0 : options.weekStartsOn) ?? ((_b = (_a12 = options == null ? void 0 : options.locale) == null ? void 0 : _a12.options) == null ? void 0 : _b.weekStartsOn) ?? defaultOptions2.weekStartsOn ?? ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) == null ? void 0 : _d.weekStartsOn) ?? 0;
  const _date = toDate(date);
...
function getWeekYear(date, options) {
  ...
  const year = _date.getFullYear();
  const defaultOptions2 = getDefaultOptions();
  const firstWeekContainsDate = (options == null ? void 0 : options.firstWeekContainsDate) ?? ((_b = (_a12 = options == null ? void 0 : options.locale) == null ? void 0 : _a12.options) == null ? void 0 : _b.firstWeekContainsDate) ?? defaultOptions2.firstWeekContainsDate ?? ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) == null ? void 0 : _d.firstWeekContainsDate) ?? 1;
...
var DefaultComponent = function() {
  return React78.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZGHUTQ5Y.js.map
