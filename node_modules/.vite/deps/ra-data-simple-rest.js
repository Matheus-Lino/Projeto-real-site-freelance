...
} from "./chunk-ZGHUTQ5Y.js";
import "./chunk-ZPMD72ZR.js";
import "./chunk-E7DHLT2A.js";
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, httpClient("".concat(apiUrl, "/").concat(resource, "/").concat(encodeURIComponent(params.id)).concat(query), { signal: params === null || params === void 0 ? void 0 : params.signal })];
            case 1:
              json = _a.sent().json;
              return [2, { data: json }];
          }
